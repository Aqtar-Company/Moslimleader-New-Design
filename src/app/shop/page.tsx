  ...
  return (
    <>
      ...
      <div className="bg-[#F5C518] py-10 text-center">
        <h1 className="text-3xl md:text-4xl font-black text-gray-900">المتجر</h1>
        <p className="text-gray-700 mt-2">اكتشف جميع منتجاتنا التربوية والتعليمية</p>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        {filtered.length > 0 ? (
          ...
          <div className="text-center py-20 text-gray-400">
            ...
            <p className="text-lg font-semibold">لا توجد منتجات تطابق بحثك</p>
          </div>
        )}
      </div>
    </>
