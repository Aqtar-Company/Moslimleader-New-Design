(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,10607,e=>{"use strict";let i=[{id:"cairo",name:"القاهرة",nameEn:"Cairo",shipping:50},{id:"giza",name:"الجيزة",nameEn:"Giza",shipping:50},{id:"qalyubia",name:"القليوبية",nameEn:"Qalyubia",shipping:55},{id:"alexandria",name:"الإسكندرية",nameEn:"Alexandria",shipping:65},{id:"sharqia",name:"الشرقية",nameEn:"Sharqia",shipping:65},{id:"dakahlia",name:"الدقهلية",nameEn:"Dakahlia",shipping:65},{id:"gharbia",name:"الغربية",nameEn:"Gharbia",shipping:65},{id:"monufia",name:"المنوفية",nameEn:"Monufia",shipping:65},{id:"suez",name:"السويس",nameEn:"Suez",shipping:65},{id:"ismailia",name:"الإسماعيلية",nameEn:"Ismailia",shipping:65},{id:"port-said",name:"بورسعيد",nameEn:"Port Said",shipping:65},{id:"beheira",name:"البحيرة",nameEn:"Beheira",shipping:70},{id:"damietta",name:"دمياط",nameEn:"Damietta",shipping:70},{id:"kafr-sheikh",name:"كفر الشيخ",nameEn:"Kafr el-Sheikh",shipping:70},{id:"fayoum",name:"الفيوم",nameEn:"Fayoum",shipping:70},{id:"beni-suef",name:"بني سويف",nameEn:"Beni Suef",shipping:80},{id:"minya",name:"المنيا",nameEn:"Minya",shipping:80},{id:"asyut",name:"أسيوط",nameEn:"Asyut",shipping:85},{id:"sohag",name:"سوهاج",nameEn:"Sohag",shipping:85},{id:"qena",name:"قنا",nameEn:"Qena",shipping:90},{id:"luxor",name:"الأقصر",nameEn:"Luxor",shipping:90},{id:"aswan",name:"أسوان",nameEn:"Aswan",shipping:95},{id:"red-sea",name:"البحر الأحمر",nameEn:"Red Sea",shipping:95},{id:"north-sinai",name:"شمال سيناء",nameEn:"North Sinai",shipping:95},{id:"south-sinai",name:"جنوب سيناء",nameEn:"South Sinai",shipping:100},{id:"matruh",name:"مطروح",nameEn:"Matruh",shipping:100},{id:"new-valley",name:"الوادي الجديد",nameEn:"New Valley",shipping:100}];function t(e){return i.find(i=>i.id===e)?.shipping??80}e.s(["getShipping",()=>t,"governorates",0,i])},70820,e=>{"use strict";var i=e.i(4662),t=e.i(10607);function r(){try{let e=localStorage.getItem("ml-coupons");if(e)return JSON.parse(e)}catch{}return{...i.DEFAULT_COUPONS}}function a(e){localStorage.setItem("ml-coupons",JSON.stringify(e))}function l(e,i){let t=r();t[e.toUpperCase().trim()]=i,a(t)}function n(e){let i=r();delete i[e],a(i)}function s(){try{let e=localStorage.getItem("ml_users");if(!e)return[];let i=JSON.parse(e);return Object.values(i).map(({user:e})=>{let i=o(e.id);return{id:e.id,name:e.name,email:e.email,phone:e.phone,orderCount:i.length}})}catch{return[]}}function o(e){try{let i=localStorage.getItem(`ml_orders_${e}`);if(!i)return[];let t=JSON.parse(i),r=localStorage.getItem("ml_users"),a="",l="";if(r){let i=JSON.parse(r),t=Object.values(i).find(i=>i.user.id===e);t&&(a=t.user.name,l=t.user.email)}let n=c();return t.map(i=>({...i,status:n[i.id]||i.status,userId:e,userName:a,userEmail:l}))}catch{return[]}}function d(){try{let e=localStorage.getItem("ml_users");if(!e)return[];let i=JSON.parse(e),t=[];return Object.values(i).forEach(({user:e})=>{t.push(...o(e.id))}),t.sort((e,i)=>i.id.localeCompare(e.id))}catch{return[]}}function c(){try{let e=localStorage.getItem("ml-order-status");if(e)return JSON.parse(e)}catch{}return{}}function p(e,i){let t=c();t[e]=i,localStorage.setItem("ml-order-status",JSON.stringify(t))}function g(){try{let e=localStorage.getItem("ml-product-overrides");if(e)return JSON.parse(e)}catch{}return{}}function h(e,i){let t=g();t[e]={...t[e],...i},localStorage.setItem("ml-product-overrides",JSON.stringify(t))}function m(){try{let e=localStorage.getItem("ml-products-added");if(e)return JSON.parse(e)}catch{}return[]}function u(e){localStorage.setItem("ml-products-added",JSON.stringify(e))}function b(e){let i=m();i.unshift(e),u(i)}function x(e){u(m().filter(i=>i.id!==e))}function y(e){let i=[];return e.forEach(({id:e,name:t})=>{try{let r=localStorage.getItem(`reviews_${e}`);if(!r)return;JSON.parse(r).forEach(r=>i.push({...r,productId:e,productName:t}))}catch{}}),i.sort((e,i)=>i.date.localeCompare(e.date))}function f(e,i){try{let t=localStorage.getItem(`reviews_${e}`);if(!t)return;let r=JSON.parse(t).filter(e=>e.id!==i);localStorage.setItem(`reviews_${e}`,JSON.stringify(r))}catch{}}function w(){try{let e=localStorage.getItem("ml-shipping-overrides");if(e)return JSON.parse(e)}catch{}return{local:{}}}function v(e){localStorage.setItem("ml-shipping-overrides",JSON.stringify(e))}function k(e){let i=w();if(void 0!==i.local[e])return i.local[e];let r=t.governorates.find(i=>i.id===e);return r?.shipping??50}e.s(["addCoupon",()=>l,"addProduct",()=>b,"deleteAddedProduct",()=>x,"deleteCoupon",()=>n,"deleteReview",()=>f,"getAddedProducts",()=>m,"getAllOrders",()=>d,"getAllReviews",()=>y,"getAllUsers",()=>s,"getCoupons",()=>r,"getEffectiveShipping",()=>k,"getOrderStatusOverrides",()=>c,"getProductOverrides",()=>g,"getShippingOverrides",()=>w,"getUserOrders",()=>o,"saveAddedProducts",()=>u,"saveCoupons",()=>a,"saveShippingOverrides",()=>v,"setOrderStatus",()=>p,"setProductOverride",()=>h])},65721,e=>{"use strict";let i="https://moslimleader.com/wp-content/uploads",t=[{id:"1",slug:"feast-day-game",name:"لعبة يوم الصائم",nameEn:"The Fasting Day Game",shortDescription:"لعبة لوحية جماعية يلعبها لاعبين فأكثر",shortDescriptionEn:"A group board game for 2 or more players",description:`<p>لعبة لوحية جماعية تساعد الأطفال على تعلم قيم الصيام بطريقة ممتعة وتفاعلية.</p>
<h3>المحتويات</h3>
<ul>
...
</ul>`,price:35,category:"إكسسوار",tags:["دبوس","هدية","إكسسوار"],images:[`${i}/2024/10/Pins.webp`,`${i}/2024/10/Black-Pin.webp`,`${i}/2024/10/White-Pin.webp`,`${i}/2024/10/Yellow-Pin.webp`,`${i}/2024/10/Boys-Pin-1.webp`,`${i}/2024/10/Girls-Pin.webp`],inStock:!1,weight:20}],r=[{id:"all",name:"الكل",count:t.length},{id:"ألعاب تعليمية",name:"ألعاب تعليمية",count:t.filter(e=>"ألعاب تعليمية"===e.category).length},{id:"كتب",name:"كتب",count:t.filter(e=>"كتب"===e.category).length},{id:"كتب الأسرة",name:"كتب الأسرة",count:t.filter(e=>"كتب الأسرة"===e.category).length},{id:"قصص الأطفال",name:"قصص الأطفال",count:t.filter(e=>"قصص الأطفال"===e.category).length},{id:"أدوات القرآن",name:"أدوات القرآن",count:t.filter(e=>"أدوات القرآن"===e.category).length},{id:"مفكرات",name:"مفكرات",count:t.filter(e=>"مفكرات"===e.category).length},{id:"إكسسوار",name:"إكسسوار",count:t.filter(e=>"إكسسوار"===e.category).length},{id:"مجات",name:"مجات",count:t.filter(e=>"مجات"===e.category).length}];e.s(["categories",0,r,"products",0,t])},76289,e=>{"use strict";var i=e.i(43476),t=e.i(71645),r=e.i(70820),a=e.i(65721);let l={slug:"",name:"",nameEn:"",shortDescription:"",shortDescriptionEn:"",description:"",descriptionEn:"",price:0,category:"",tags:[],images:[],inStock:!0,featured:!1,weight:0};function n(){let[n,s]=(0,t.useState)({}),[o,d]=(0,t.useState)([]),[c,p]=(0,t.useState)(null),[g,h]=(0,t.useState)(""),[m,u]=(0,t.useState)(!1),[b,x]=(0,t.useState)(l),[y,f]=(0,t.useState)(""),[w,v]=(0,t.useState)(""),[k,S]=(0,t.useState)(!1),$=(0,t.useCallback)(()=>{s((0,r.getProductOverrides)()),d((0,r.getAddedProducts)())},[]);(0,t.useEffect)(()=>{$()},[$]);let j=[...a.products.map(e=>({...e,price:n[e.id]?.price??e.price,inStock:n[e.id]?.inStock??e.inStock,featured:n[e.id]?.featured??e.featured})),...o.map(e=>({...e,isAdded:!0}))],E=i=>{let t=parseFloat(g);if(isNaN(t)||t<=0)return void p(null);if(i.isAdded){let r=o.map(e=>e.id===i.id?{...e,price:t}:e);d(r);let{saveAddedProducts:a}=e.r(70820);a(r)}else(0,r.setProductOverride)(i.id,{price:t}),$();p(null)},N=a.categories.filter(e=>"all"!==e.id).map(e=>e.name);return(0,i.jsxs)("div",{className:"space-y-5",children:[(0,i.jsxs)("div",{className:"flex items-center justify-between",children:[(0,i.jsxs)("div",{children:[(0,i.jsx)("h1",{className:"text-xl font-black text-gray-900",children:"المنتجات"}),(0,i.jsxs)("p",{className:"text-sm text-gray-500 mt-0.5",children:[j.length," منتج"]})]}),(0,i.jsxs)("button",{onClick:()=>u(!0),className:"bg-[#F5C518] hover:bg-amber-400 text-[#1a1a2e] font-bold px-4 py-2.5 rounded-xl text-sm transition flex items-center gap-2",children:[(0,i.jsx)("span",{children:"+"})," إضافة منتج"]})]}),m&&(0,i.jsxs)("div",{className:"bg-white border border-gray-200 rounded-2xl p-6 space-y-4",children:[(0,i.jsx)("h2",{className:"font-bold text-gray-900 text-base",children:"إضافة منتج جديد"}),(0,i.jsxs)("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4",children:[(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"الاسم (عربي) *"}),(0,i.jsx)("input",{value:b.name,onChange:e=>x(i=>({...i,name:e.target.value})),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400"})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"الاسم (إنجليزي)"}),(0,i.jsx)("input",{value:b.nameEn||"",onChange:e=>x(i=>({...i,nameEn:e.target.value})),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400",dir:"ltr"})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"Slug (للرابط) *"}),(0,i.jsx)("input",{value:b.slug,onChange:e=>x(i=>({...i,slug:e.target.value.toLowerCase().replace(/\s+/g,"-")})),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400 font-mono",dir:"ltr",placeholder:"product-name"})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"الفئة *"}),(0,i.jsxs)("select",{value:b.category,onChange:e=>x(i=>({...i,category:e.target.value})),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400 bg-white",children:[(0,i.jsx)("option",{value:"",children:"— اختر فئة —"}),N.map(e=>(0,i.jsx)("option",{value:e,children:e},e))]})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"السعر (EGP) *"}),(0,i.jsx)("input",{type:"number",value:b.price||"",onChange:e=>x(i=>({...i,price:+e.target.value})),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400",min:"0"})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"الوزن (جرام)"}),(0,i.jsx)("input",{type:"number",value:b.weight||"",onChange:e=>x(i=>({...i,weight:+e.target.value})),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400",min:"0"})]}),(0,i.jsxs)("div",{className:"sm:col-span-2",children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"الوصف المختصر"}),(0,i.jsx)("input",{value:b.shortDescription,onChange:e=>x(i=>({...i,shortDescription:e.target.value})),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400"})]}),(0,i.jsxs)("div",{className:"sm:col-span-2",children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"الوصف الكامل (HTML مسموح)"}),(0,i.jsx)("textarea",{value:b.description,onChange:e=>x(i=>({...i,description:e.target.value})),rows:4,className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400 resize-none"})]}),(0,i.jsxs)("div",{className:"sm:col-span-2",children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"روابط الصور (رابط واحد في كل سطر)"}),(0,i.jsx)("textarea",{value:w,onChange:e=>v(e.target.value),rows:3,className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400 resize-none font-mono",dir:"ltr",placeholder:"https://example.com/image1.jpg https://example.com/image2.jpg"})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"Tags (مفصولة بفاصلة)"}),(0,i.jsx)("input",{value:y,onChange:e=>f(e.target.value),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400",placeholder:"لعبة, أطفال, تعليمي"})]}),(0,i.jsxs)("div",{className:"flex items-center gap-6 pt-4",children:[(0,i.jsxs)("label",{className:"flex items-center gap-2 cursor-pointer",children:[(0,i.jsx)("input",{type:"checkbox",checked:b.inStock,onChange:e=>x(i=>({...i,inStock:e.target.checked})),className:"w-4 h-4 accent-[#F5C518]"}),(0,i.jsx)("span",{className:"text-sm font-semibold text-gray-700",children:"متوفر في المخزن"})]}),(0,i.jsxs)("label",{className:"flex items-center gap-2 cursor-pointer",children:[(0,i.jsx)("input",{type:"checkbox",checked:b.featured||!1,onChange:e=>x(i=>({...i,featured:e.target.checked})),className:"w-4 h-4 accent-[#F5C518]"}),(0,i.jsx)("span",{className:"text-sm font-semibold text-gray-700",children:"منتج مميز"})]})]})]}),(0,i.jsxs)("div",{className:"flex gap-3 pt-2",children:[(0,i.jsx)("button",{onClick:()=>{if(!b.name||!b.slug||!b.price||!b.category)return void alert("يرجى ملء الحقول المطلوبة: الاسم، الـ Slug، السعر، الفئة");S(!0);let e={...b,id:`added-${Date.now()}`,tags:y.split(",").map(e=>e.trim()).filter(Boolean),images:w.split("\n").map(e=>e.trim()).filter(Boolean),reviews:[]};(0,r.addProduct)(e),u(!1),x(l),f(""),v(""),S(!1),$()},disabled:k,className:"bg-[#1a1a2e] text-white font-bold px-6 py-2.5 rounded-xl text-sm hover:bg-[#2a2a4e] transition disabled:opacity-50",children:k?"جارٍ الحفظ...":"حفظ المنتج"}),(0,i.jsx)("button",{onClick:()=>u(!1),className:"border border-gray-200 text-gray-600 font-semibold px-6 py-2.5 rounded-xl text-sm hover:bg-gray-50 transition",children:"إلغاء"})]})]}),(0,i.jsx)("div",{className:"bg-white rounded-2xl border border-gray-200 overflow-hidden",children:(0,i.jsx)("div",{className:"overflow-x-auto",children:(0,i.jsxs)("table",{className:"w-full text-sm",children:[(0,i.jsx)("thead",{className:"bg-gray-50 border-b border-gray-100",children:(0,i.jsxs)("tr",{className:"text-xs text-gray-500 font-semibold",children:[(0,i.jsx)("th",{className:"px-4 py-3.5 text-right",children:"المنتج"}),(0,i.jsx)("th",{className:"px-4 py-3.5 text-right",children:"الفئة"}),(0,i.jsx)("th",{className:"px-4 py-3.5 text-right",children:"السعر"}),(0,i.jsx)("th",{className:"px-4 py-3.5 text-center",children:"المخزون"}),(0,i.jsx)("th",{className:"px-4 py-3.5 text-center",children:"مميز"}),(0,i.jsx)("th",{className:"px-4 py-3.5 text-center",children:"إجراءات"})]})}),(0,i.jsx)("tbody",{className:"divide-y divide-gray-50",children:j.map(t=>(0,i.jsxs)("tr",{className:"hover:bg-gray-50 transition",children:[(0,i.jsx)("td",{className:"px-4 py-3",children:(0,i.jsxs)("div",{className:"flex items-center gap-3",children:[(0,i.jsx)("div",{className:"w-10 h-10 rounded-lg overflow-hidden bg-gray-100 shrink-0",children:t.images[0]&&(0,i.jsx)("img",{src:t.images[0],alt:t.name,className:"w-full h-full object-cover"})}),(0,i.jsxs)("div",{children:[(0,i.jsx)("p",{className:"font-semibold text-gray-900 text-xs leading-tight",children:t.name}),t.nameEn&&(0,i.jsx)("p",{className:"text-gray-400 text-xs",children:t.nameEn}),t.isAdded&&(0,i.jsx)("span",{className:"text-xs bg-purple-100 text-purple-600 px-1.5 py-0.5 rounded-full font-bold",children:"مضاف"})]})]})}),(0,i.jsx)("td",{className:"px-4 py-3 text-gray-500 text-xs",children:t.category}),(0,i.jsx)("td",{className:"px-4 py-3",children:c===t.id?(0,i.jsxs)("div",{className:"flex items-center gap-1.5",children:[(0,i.jsx)("input",{type:"number",value:g,onChange:e=>h(e.target.value),onKeyDown:e=>{"Enter"===e.key&&E(t),"Escape"===e.key&&p(null)},autoFocus:!0,className:"w-20 border border-gray-300 rounded-lg px-2 py-1 text-xs outline-none focus:border-[#F5C518]"}),(0,i.jsx)("button",{onClick:()=>E(t),className:"text-green-600 hover:text-green-700 font-bold text-xs",children:"✓"}),(0,i.jsx)("button",{onClick:()=>p(null),className:"text-gray-400 hover:text-gray-600 text-xs",children:"✕"})]}):(0,i.jsxs)("button",{onClick:()=>{p(t.id),h(t.price.toString())},className:"font-bold text-gray-900 hover:text-[#1a1a2e] hover:underline text-xs",children:[t.price.toLocaleString("ar-EG")," ج"]})}),(0,i.jsx)("td",{className:"px-4 py-3 text-center",children:(0,i.jsx)("button",{onClick:()=>(i=>{if(i.isAdded){let t=o.map(e=>e.id===i.id?{...e,inStock:!e.inStock}:e);d(t);let{saveAddedProducts:r}=e.r(70820);r(t)}else(0,r.setProductOverride)(i.id,{inStock:!i.inStock}),$()})(t),className:`px-2.5 py-1 rounded-full text-xs font-bold transition ${t.inStock?"bg-green-100 text-green-700 hover:bg-green-200":"bg-red-100 text-red-600 hover:bg-red-200"}`,children:t.inStock?"متوفر":"نفذ"})}),(0,i.jsx)("td",{className:"px-4 py-3 text-center",children:(0,i.jsx)("button",{onClick:()=>(i=>{if(i.isAdded){let t=o.map(e=>e.id===i.id?{...e,featured:!e.featured}:e);d(t);let{saveAddedProducts:r}=e.r(70820);r(t)}else(0,r.setProductOverride)(i.id,{featured:!i.featured}),$()})(t),className:`text-lg transition hover:scale-125 ${t.featured?"opacity-100":"opacity-25"}`,children:"⭐"})}),(0,i.jsx)("td",{className:"px-4 py-3 text-center",children:t.isAdded&&(0,i.jsx)("button",{onClick:()=>{!t.isAdded||confirm(`حذف "${t.name}"؟`)&&((0,r.deleteAddedProduct)(t.id),$())},className:"text-red-400 hover:text-red-600 text-xs font-bold transition",children:"حذف"})})]},t.id))})]})})})]})}e.s(["default",()=>n])}]);