...
export async function POST(req: NextRequest) {
  ...
  const enrichedPrompt =
    ...
    `## ملاحظة عن القناة:\nهذا تواصل من **زائر على الموقع** (وليس Messenger). الردود ستظهر في واجهة الدردشة على https://moslimleader.com — يمكنك توجيهه لروابط منتجات، صفحة عربة التسوق، أو صفحة الدفع مباشرة.\n\n` +
