...
import TareeqAvatarImg from './TareeqAvatarImg';
...
// three (nothing opened on desktop, a full-screen list on mobile). Sharing is now
// TareeqShareSheet, a centred modal with no anchor to get wrong.
