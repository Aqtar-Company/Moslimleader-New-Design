...
const HEIR_TYPES = [
  ...
  },
  {
    ...
    icon: '👵🏽',
    color: '#B8722E',
    description: 'الجدة تُحجب كليًا بوجود الأم، وتأخذ السدس عند غياب الأم.',
    count: 5
  },
  {
    id: 'husband',
...
const CASE_CARDS_PREVIEW = [
  ...
  { id: 41, difficulty: 'mixed', deceasedGender: 'male', estateValue: 24,
    ...
    title: 'قضية 41', note: 'متوفى بلا أب ولا ابن، وورثته: أخت شقيقة وبنت.', lesson: 'مسألة خلافية بين الفقهاء (تعصيب الأخت مع الغير) — غير مطبَّقة في هذه النسخة، وتُعرض كحالة تحتاج مراجعة.' },
  { id: 42, difficulty: 'mixed', deceasedGender: 'female', estateValue: 24,
    ...
    title: 'قضية 42', note: 'متوفاة بلا أب ولا ابن، وورثتها: أخ شقيق وبنت.', lesson: 'نفس المسألة الخلافية (تعصيب الأخ مع الغير) — تُعرض كحالة تحتاج مراجعة بلا ترجيح.' },
