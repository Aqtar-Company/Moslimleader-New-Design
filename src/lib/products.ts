...
<ul>
  ...
  <li>Metal spiral binding</li>
    ...
    variants: [
      { id: 'boys', name: 'أولاد', nameEn: 'Boys', imageIndex: 0 },
      { id: 'girls', name: 'بنات', nameEn: 'Girls', imageIndex: 3 },
    ],
    inStock: true,
    videos: ['9kSSCSAg2us'],
    weight: 375,
...
<ul>
  ...
  <li>Metal spiral binding</li>
    ...
    variants: [
      { id: 'men', name: 'رجال', nameEn: 'Men', imageIndex: 1 },
      { id: 'women', name: 'سيدات', nameEn: 'Women', imageIndex: 4 },
    ],
    inStock: true,
    videos: ['9kSSCSAg2us'],
    weight: 273,
...
<ul>
  ...
  <li>33 × 28 × 12 cm</li>
    ...
    variants: [
      { id: 'boys', name: 'أولاد', nameEn: 'Boys', imageIndex: 0 },
      { id: 'girls', name: 'بنات', nameEn: 'Girls', imageIndex: 2 },
    ],
    inStock: true,
    weight: 400,
  },
...
<p><strong>App is free on Google Play</strong></p>`,
    ...
    variants: [
      { id: 'yellow', name: 'أصفر', nameEn: 'Yellow', imageIndex: 1 },
      { id: 'green',  name: 'أخضر', nameEn: 'Green',  imageIndex: 2 },
      { id: 'pink',   name: 'وردي', nameEn: 'Pink',   imageIndex: 3 },
      { id: 'blue',   name: 'أزرق', nameEn: 'Blue',   imageIndex: 4 },
    ],
    inStock: true,
    weight: 450,
    reviews: [
