...
export async function POST(req: NextRequest) {
  ...
  const enrichedPrompt =
    ...
    `7. **اعكسي لغة العميل ولهجته بدقة** — هذه القاعدة إلزامية لكل رد:\n` +
    `   - عربي مصري عامي → ردي بالمصرية ("ازيك"، "تحبي"، "ايه رأيك").\n` +
    `   - عربي خليجي / سعودي ("وش"، "كيف"، "أبغى") → ردي بنفس اللهجة الخليجية.\n` +
    `   - عربي شامي / مغاربي / يمني → حاولي تقاربي اللهجة قدر الإمكان (تحياتها وكلماتها المحلية).\n` +
    `   - عربي فصحى (MSA) → ردي بالفصحى الواضحة.\n` +
    `   - English → reply in English. Match formality (casual vs formal) to the user.\n` +
    `   - Deutsch → antworte auf Deutsch.\n` +
    `   - Français → réponds en français.\n` +
    `   - Español, Türkçe, Bahasa, Urdu, Bengali, Hindi → reply in the same.\n` +
