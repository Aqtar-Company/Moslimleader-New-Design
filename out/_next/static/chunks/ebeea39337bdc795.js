(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,65721,42129,e=>{"use strict";let i="https://moslimleader.com/wp-content/uploads",l=[{id:"1",slug:"feast-day-game",name:"لعبة يوم الصائم",nameEn:"The Fasting Day Game",shortDescription:"لعبة لوحية جماعية يلعبها لاعبين فأكثر",shortDescriptionEn:"A group board game for 2 or more players",description:`<p>لعبة لوحية جماعية تساعد الأطفال على تعلم قيم الصيام بطريقة ممتعة وتفاعلية.</p>
<h3>المحتويات</h3>
<ul>
...
<ul>
  ...
  <li>2 sticker pages</li>
  <li>Metal spiral binding</li>
</ul>`,price:160,category:"مفكرات",tags:["مفكرة","كبار","تنظيم","عبادات"],images:[`${i}/2024/07/Adults-Notebook-Cover.webp`,`${i}/2024/07/Men-Notebook-1.webp`,`${i}/2024/07/Men-Notebook-2.webp`,`${i}/2024/07/Men-Notebook-3.webp`,`${i}/2024/07/Women-Notebook-1.webp`,`${i}/2024/07/Women-Notebook-2.webp`,`${i}/2024/07/Women-Notebook-3.webp`],inStock:!0,videos:["9kSSCSAg2us"]},{id:"18",slug:"ml-bag",name:"شنطة مسلم ليدر",nameEn:"Moslim Leader Bag",shortDescription:"شنطة مدرسية للحضانة KG1–KG2 بتصاميم إسلامية",shortDescriptionEn:"A school bag for kindergarten KG1–KG2 with Islamic designs",description:`<p>شنطة مسلم ليدر برسومات مناسبة لهويتنا وثقافتنا، بعيداً عن أوهام الشخصيات الدخيلة. متوفرة نموذجين أولاد وبنات.</p>
<h3>المواصفات</h3>
<ul>
...
</ul>`,price:35,category:"إكسسوار",tags:["دبوس","هدية","إكسسوار"],images:[`${i}/2024/10/Pins.webp`,`${i}/2024/10/Black-Pin.webp`,`${i}/2024/10/White-Pin.webp`,`${i}/2024/10/Yellow-Pin.webp`,`${i}/2024/10/Boys-Pin-1.webp`,`${i}/2024/10/Girls-Pin.webp`],inStock:!1}],r=[{id:"all",name:"الكل",count:l.length},{id:"ألعاب تعليمية",name:"ألعاب تعليمية",count:l.filter(e=>"ألعاب تعليمية"===e.category).length},{id:"كتب",name:"كتب",count:l.filter(e=>"كتب"===e.category).length},{id:"كتب الأسرة",name:"كتب الأسرة",count:l.filter(e=>"كتب الأسرة"===e.category).length},{id:"قصص الأطفال",name:"قصص الأطفال",count:l.filter(e=>"قصص الأطفال"===e.category).length},{id:"أدوات القرآن",name:"أدوات القرآن",count:l.filter(e=>"أدوات القرآن"===e.category).length},{id:"مفكرات",name:"مفكرات",count:l.filter(e=>"مفكرات"===e.category).length},{id:"إكسسوار",name:"إكسسوار",count:l.filter(e=>"إكسسوار"===e.category).length},{id:"مجات",name:"مجات",count:l.filter(e=>"مجات"===e.category).length}];e.s(["categories",0,r,"products",0,l],65721);var t=e.i(43476),o=e.i(22016),s=e.i(57688),a=e.i(25194),n=e.i(83773);function d({product:e}){let{addItem:i}=(0,a.useCart)(),{t:l,isRtl:r}=(0,n.useLang)(),d=r?e.name:e.nameEn||e.name,c=r?e.shortDescription:e.shortDescriptionEn||e.shortDescription;return(0,t.jsxs)("div",{className:"bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-gray-100 overflow-hidden flex flex-col",children:[(0,t.jsxs)(o.default,{href:`/shop/${e.slug}`,target:"_blank",rel:"noopener noreferrer",className:"block relative aspect-square overflow-hidden bg-gray-50",children:[(0,t.jsx)(s.default,{src:e.images[0],alt:d,fill:!0,className:"object-cover hover:scale-105 transition-transform duration-300",unoptimized:!0}),!e.inStock&&(0,t.jsx)("div",{className:"absolute inset-0 bg-black/40 flex items-center justify-center",children:(0,t.jsx)("span",{className:"bg-white text-gray-800 text-xs font-bold px-3 py-1 rounded-full",children:l("product.outOfStock")})})]}),(0,t.jsxs)("div",{className:"p-4 flex flex-col gap-2 flex-1",children:[(0,t.jsx)(o.default,{href:`/shop/${e.slug}`,target:"_blank",rel:"noopener noreferrer",children:(0,t.jsx)("h3",{className:"font-bold text-gray-900 text-base leading-snug hover:text-purple-700 transition line-clamp-2",children:d})}),(0,t.jsx)("p",{className:"text-gray-500 text-sm line-clamp-2",children:c}),(0,t.jsxs)("div",{className:"mt-auto pt-3 flex items-center justify-between gap-2",children:[(0,t.jsxs)("span",{className:"text-gray-900 font-bold text-lg",children:[e.price," ",l("cart.currency")]}),(0,t.jsx)("button",{disabled:!e.inStock,onClick:()=>e.inStock&&i(e),className:"bg-purple-700 hover:bg-purple-800 disabled:bg-gray-300 disabled:cursor-not-allowed text-white text-sm font-semibold px-4 py-2 rounded-xl transition",children:l(e.inStock?"product.addToCart":"product.unavailable")})]})]})]})}e.s(["default",()=>d],42129)},3365,e=>{"use strict";var i=e.i(43476),l=e.i(71645),r=e.i(57688),t=e.i(22016),o=e.i(65721),s=e.i(25194),a=e.i(83773),n=e.i(42129);function d({product:e}){let[d,c]=(0,l.useState)(0),[p,h]=(0,l.useState)(1),[g,u]=(0,l.useState)(!1),{addItem:m}=(0,s.useCart)(),{t:b,isRtl:y}=(0,a.useLang)(),x=e.videos??[],w=y?e.name:e.nameEn||e.name,f=y?e.shortDescription:e.shortDescriptionEn||e.shortDescription,k=y?e.description:e.descriptionEn||e.description,$=o.products.filter(i=>i.category===e.category&&i.id!==e.id).slice(0,4);return(0,i.jsxs)("div",{dir:y?"rtl":"ltr",children:[(0,i.jsx)("div",{className:"bg-gray-50 py-3 border-b",children:(0,i.jsxs)("div",{className:"max-w-6xl mx-auto px-4 flex items-center gap-2 text-sm text-gray-500",children:[(0,i.jsx)(t.default,{href:"/",className:"hover:text-gray-900 transition",children:b("nav.home")}),(0,i.jsx)("span",{children:"/"}),(0,i.jsx)(t.default,{href:"/",className:"hover:text-gray-900 transition",children:b("nav.shop")}),(0,i.jsx)("span",{children:"/"}),(0,i.jsx)("span",{className:"text-gray-900 font-medium",children:w})]})}),(0,i.jsxs)("div",{className:"max-w-6xl mx-auto px-4 py-10",children:[(0,i.jsxs)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-10",children:[(0,i.jsxs)("div",{className:"flex flex-col gap-4",children:[(0,i.jsxs)("div",{className:"relative aspect-square rounded-2xl overflow-hidden bg-gray-50 border border-gray-100",children:[(0,i.jsx)(r.default,{src:e.images[d],alt:w,fill:!0,className:"object-contain p-4",unoptimized:!0}),!e.inStock&&(0,i.jsx)("div",{className:"absolute top-3 right-3 bg-gray-900 text-white text-xs font-bold px-3 py-1 rounded-full",children:b("product.outOfStock")})]}),e.images.length>1&&(0,i.jsx)("div",{className:"flex gap-2 overflow-x-auto pb-1",children:e.images.map((e,l)=>(0,i.jsx)("button",{onClick:()=>c(l),className:`relative w-16 h-16 shrink-0 rounded-xl overflow-hidden border-2 transition ${d===l?"border-[#F5C518]":"border-gray-200 hover:border-gray-400"}`,children:(0,i.jsx)(r.default,{src:e,alt:"",fill:!0,className:"object-cover",unoptimized:!0})},l))})]}),(0,i.jsxs)("div",{className:"flex flex-col gap-5",children:[(0,i.jsx)("div",{children:(0,i.jsx)("span",{className:"bg-[#FFF9E6] text-[#9a7b00] text-xs font-bold px-3 py-1 rounded-full",children:e.category})}),(0,i.jsx)("h1",{className:"text-2xl md:text-3xl font-black text-gray-900 leading-tight",children:w}),(0,i.jsx)("p",{className:"text-gray-500",children:f}),(0,i.jsxs)("div",{className:"text-3xl font-black text-gray-900",children:[e.price," ",(0,i.jsx)("span",{className:"text-lg font-bold text-gray-500",children:b("cart.currency")})]}),(0,i.jsxs)("div",{className:"flex items-center gap-2",children:[(0,i.jsx)("div",{className:`w-2.5 h-2.5 rounded-full ${e.inStock?"bg-green-500":"bg-red-400"}`}),(0,i.jsx)("span",{className:`text-sm font-semibold ${e.inStock?"text-green-600":"text-red-500"}`,children:b(e.inStock?"product.inStock":"product.outOfStock")})]}),e.inStock&&(0,i.jsxs)("div",{className:"flex items-center gap-3",children:[(0,i.jsxs)("div",{className:"flex items-center border-2 border-gray-200 rounded-xl overflow-hidden",children:[(0,i.jsx)("button",{onClick:()=>h(e=>Math.max(1,e-1)),className:"w-10 h-10 flex items-center justify-center text-xl font-bold hover:bg-gray-100 transition",children:"−"}),(0,i.jsx)("span",{className:"w-10 text-center font-bold",children:p}),(0,i.jsx)("button",{onClick:()=>h(e=>e+1),className:"w-10 h-10 flex items-center justify-center text-xl font-bold hover:bg-gray-100 transition",children:"+"})]}),(0,i.jsx)("button",{onClick:function(){for(let i=0;i<p;i++)m(e);u(!0),setTimeout(()=>u(!1),2e3)},className:"flex-1 bg-purple-700 hover:bg-purple-800 text-white font-bold py-3 px-6 rounded-xl transition text-center",children:b(g?"product.added":"product.addToCart")})]}),(0,i.jsx)("div",{className:"product-description border-t pt-5 mt-2",dangerouslySetInnerHTML:{__html:k}}),e.tags.length>0&&(0,i.jsx)("div",{className:"flex flex-wrap gap-2 pt-2",children:e.tags.map(e=>(0,i.jsxs)("span",{className:"bg-gray-100 text-gray-600 text-xs px-3 py-1 rounded-full",children:["#",e]},e))})]})]}),x.length>0&&(0,i.jsxs)("div",{className:"mt-12 border-t border-gray-100 pt-10",children:[(0,i.jsxs)("h2",{className:"text-xl font-black text-gray-900 mb-6 flex items-center gap-2.5",children:[(0,i.jsx)("span",{className:"w-8 h-8 rounded-xl bg-red-600 flex items-center justify-center shrink-0",children:(0,i.jsx)("svg",{className:"w-4 h-4 text-white fill-current",viewBox:"0 0 24 24",children:(0,i.jsx)("path",{d:"M8 5v14l11-7z"})})}),y?"فيديوهات المنتج":"Product Videos"]}),(0,i.jsx)("div",{className:`grid gap-5 ${1===x.length?"grid-cols-1 max-w-2xl":"grid-cols-1 md:grid-cols-2"}`,children:x.map((e,l)=>(0,i.jsx)("div",{className:"rounded-2xl overflow-hidden border border-gray-100 shadow-sm bg-black aspect-video",children:(0,i.jsx)("iframe",{src:`https://www.youtube.com/embed/${e}`,title:`${w} - ${y?"فيديو":"Video"} ${l+1}`,allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0,className:"w-full h-full border-0"})},e))})]}),$.length>0&&(0,i.jsxs)("div",{className:"mt-16",children:[(0,i.jsx)("h2",{className:"text-xl font-black text-gray-900 mb-6",children:b("product.related")}),(0,i.jsx)("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-5",children:$.map(e=>(0,i.jsx)(n.default,{product:e},e.id))})]})]})]})}e.s(["default",()=>d])}]);