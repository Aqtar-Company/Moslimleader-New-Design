  ...
  return (
    <div className="space-y-3">
      ...
      >
        ...
        <div className="min-w-0">
          <p className="text-xs font-bold leading-tight" style={{ color: 'inherit' }}>
            {isRtl ? 'متجر مسلم ليدر' : 'Moslim Leader Store'}
          </p>
          <p className="text-[10px] leading-none mt-0.5" style={{ color: 'var(--tr-text-muted)' }}>
            moslimleader.com
          </p>
        </div>
        <svg className="w-3.5 h-3.5 shrink-0 ms-auto" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24" style={{ color: 'var(--tr-text-muted)' }}>
