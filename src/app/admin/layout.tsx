...
const NAV: NavItem[] = [
  ...
  { href: '/admin/returns',           label: 'طلبات الإرجاع',     icon: '↩️', requireAny: ['orders.read'] },
  ...
  { href: '/admin/free-media',        label: 'وسائط مجانية',      icon: '🎵', requireAny: ['books.read', 'free-media.read'] },
  // —— Production & sourcing ——
