...
</ul>`,price:35,category:"إكسسوار",tags:["دبوس","هدية","إكسسوار"],images:[`${i}/2024/10/Pins.webp`,`${i}/2024/10/Black-Pin.webp`,`${i}/2024/10/White-Pin.webp`,`${i}/2024/10/Yellow-Pin.webp`,`${i}/2024/10/Boys-Pin-1.webp`,`${i}/2024/10/Girls-Pin.webp`],inStock:!1,weight:20}],r=[{id:"all",name:"الكل",count:t.length},{id:"ألعاب تعليمية",name:"ألعاب تعليمية",count:t.filter(e=>"ألعاب تعليمية"===e.category).length},{id:"كتب",name:"كتب",count:t.filter(e=>"كتب"===e.category).length},{id:"كتب الأسرة",name:"كتب الأسرة",count:t.filter(e=>"كتب الأسرة"===e.category).length},{id:"قصص الأطفال",name:"قصص الأطفال",count:t.filter(e=>"قصص الأطفال"===e.category).length},{id:"أدوات القرآن",name:"أدوات القرآن",count:t.filter(e=>"أدوات القرآن"===e.category).length},{id:"مفكرات",name:"مفكرات",count:t.filter(e=>"مفكرات"===e.category).length},{id:"إكسسوار",name:"إكسسوار",count:t.filter(e=>"إكسسوار"===e.category).length},{id:"مجات",name:"مجات",count:t.filter(e=>"مجات"===e.category).length}];e.s(["categories",0,r,"products",0,t],65721);var l=e.i(43476),s=e.i(22016),a=e.i(57688),o=e.i(25194),n=e.i(88603),d=e.i(83773);function c({product:e}){let{addItem:i}=(0,o.useCart)(),{isWishlisted:t,toggle:r}=(0,n.useWishlist)(),{t:c,isRtl:p}=(0,d.useLang)(),h=p?e.name:e.nameEn||e.name,g=p?e.shortDescription:e.shortDescriptionEn||e.shortDescription,m=t(e.id);return(0,l.jsxs)("div",{className:"bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-gray-100 overflow-hidden flex flex-col",children:[(0,l.jsxs)(s.default,{href:`/shop/${e.slug}`,target:"_blank",rel:"noopener noreferrer",className:"block relative aspect-square overflow-hidden bg-gray-50",children:[(0,l.jsx)(a.default,{src:e.images[0],alt:h,fill:!0,className:"object-cover hover:scale-105 transition-transform duration-300",unoptimized:!0}),!e.inStock&&(0,l.jsx)("div",{className:"absolute inset-0 bg-black/40 flex items-center justify-center",children:(0,l.jsx)("span",{className:"bg-white text-gray-800 text-xs font-bold px-3 py-1 rounded-full",children:c("product.outOfStock")})}),(0,l.jsx)("button",{onClick:i=>{i.preventDefault(),i.stopPropagation(),r(e)},className:"absolute top-2 right-2 w-8 h-8 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center shadow-sm hover:scale-110 transition z-10","aria-label":c(m?"wishlist.remove":"wishlist.add"),children:(0,l.jsx)("svg",{className:"w-4 h-4 transition",fill:m?"#ef4444":"none",stroke:m?"#ef4444":"#9ca3af",strokeWidth:2,viewBox:"0 0 24 24",children:(0,l.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z"})})})]}),(0,l.jsxs)("div",{className:"p-4 flex flex-col gap-2 flex-1",children:[(0,l.jsx)(s.default,{href:`/shop/${e.slug}`,target:"_blank",rel:"noopener noreferrer",children:(0,l.jsx)("h3",{className:"font-bold text-gray-900 text-base leading-snug hover:text-purple-700 transition line-clamp-2",children:h})}),(0,l.jsx)("p",{className:"text-gray-500 text-sm line-clamp-2",children:g}),(0,l.jsxs)("div",{className:"mt-auto pt-3 flex items-center justify-between gap-2",children:[(0,l.jsxs)("span",{className:"text-gray-900 font-bold text-lg",children:[e.price," ",c("cart.currency")]}),(0,l.jsx)("button",{disabled:!e.inStock,onClick:()=>e.inStock&&i(e),className:"bg-purple-700 hover:bg-purple-800 disabled:bg-gray-300 disabled:cursor-not-allowed text-white text-sm font-semibold px-4 py-2 rounded-xl transition",children:c(e.inStock?"product.addToCart":"product.unavailable")})]})]})]})}e.s(["default",()=>c],42129)},3365,e=>{"use strict";var i=e.i(43476),t=e.i(71645),r=e.i(57688),l=e.i(22016),s=e.i(65721),a=e.i(25194),o=e.i(88603),n=e.i(83773),d=e.i(42129);let c=["مجات","مفكرات"],p=["masek","ml-pin"],h=["ml-bag"];function g({product:e}){let g,m,u,[x,b]=(0,t.useState)(0),[w,f]=(0,t.useState)(1),[y,v]=(0,t.useState)(!1),[k,j]=(0,t.useState)(void 0),[$,N]=(0,t.useState)(!1),[S,M]=(0,t.useState)(!1),[E,A]=(0,t.useState)(""),[C,D]=(0,t.useState)(0),[z,P]=(0,t.useState)(""),[B,L]=(0,t.useState)(!1),[G,H]=(0,t.useState)(!1),[W,T]=(0,t.useState)([]),{addItem:I}=(0,a.useCart)(),{isWishlisted:F,toggle:R}=(0,o.useWishlist)(),{t:q,isRtl:K}=(0,n.useLang)();(0,t.useEffect)(()=>{try{let i=localStorage.getItem(`reviews_${e.id}`);i&&T(JSON.parse(i))}catch{}},[e.id]);let O=c.includes(e.category)||p.includes(e.slug)||h.includes(e.slug),_=+!h.includes(e.slug),V=O?e.images.slice(_):[],Q=e.videos??[],U=K?e.name:e.nameEn||e.name,J=K?e.shortDescription:e.shortDescriptionEn||e.shortDescription,Y=K?e.description:e.descriptionEn||e.description,X=s.products.filter(i=>i.category===e.category&&i.id!==e.id).slice(0,4);function Z(e){let i=encodeURIComponent(window.location.href),t=encodeURIComponent(U),r={whatsapp:`https://wa.me/?text=${t}%20${i}`,facebook:`https://www.facebook.com/sharer/sharer.php?u=${i}`,x:`https://twitter.com/intent/tweet?url=${i}&text=${t}`};window.open(r[e],"_blank","noopener,noreferrer")}return(0,i.jsxs)("div",{dir:K?"rtl":"ltr",children:[(0,i.jsx)("div",{className:"bg-gray-50 py-3 border-b",children:(0,i.jsxs)("div",{className:"max-w-6xl mx-auto px-4 flex items-center gap-2 text-sm text-gray-500",children:[(0,i.jsx)(l.default,{href:"/",className:"hover:text-gray-900 transition",children:q("nav.home")}),(0,i.jsx)("span",{children:"/"}),(0,i.jsx)(l.default,{href:"/",className:"hover:text-gray-900 transition",children:q("nav.shop")}),(0,i.jsx)("span",{children:"/"}),(0,i.jsx)("span",{className:"text-gray-900 font-medium",children:U})]})}),(0,i.jsxs)("div",{className:"max-w-6xl mx-auto px-4 py-10",children:[(0,i.jsxs)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-10",children:[(0,i.jsxs)("div",{className:"flex flex-col gap-4",children:[(0,i.jsxs)("div",{className:"relative aspect-square rounded-2xl overflow-hidden bg-gray-50 border border-gray-100",children:[(0,i.jsx)(r.default,{src:e.images[x],alt:U,fill:!0,className:"object-contain p-4",unoptimized:!0}),!e.inStock&&(0,i.jsx)("div",{className:"absolute top-3 right-3 bg-gray-900 text-white text-xs font-bold px-3 py-1 rounded-full",children:q("product.outOfStock")})]}),e.images.length>1&&(0,i.jsx)("div",{className:"flex gap-2 overflow-x-auto pb-1",children:e.images.map((e,t)=>(0,i.jsx)("button",{onClick:()=>b(t),className:`relative w-16 h-16 shrink-0 rounded-xl overflow-hidden border-2 transition ${x===t?"border-[#F5C518]":"border-gray-200 hover:border-gray-400"}`,children:(0,i.jsx)(r.default,{src:e,alt:"",fill:!0,className:"object-cover",unoptimized:!0})},t))})]}),(0,i.jsxs)("div",{className:"flex flex-col gap-5",children:[(0,i.jsx)("div",{children:(0,i.jsx)("span",{className:"bg-[#FFF9E6] text-[#9a7b00] text-xs font-bold px-3 py-1 rounded-full",children:q(`cat.${e.category}`)})}),(0,i.jsx)("h1",{className:"text-2xl md:text-3xl font-black text-gray-900 leading-tight",children:U}),(0,i.jsx)("p",{className:"text-gray-500",children:J}),(0,i.jsxs)("div",{className:"text-3xl font-black text-gray-900",children:[e.price," ",(0,i.jsx)("span",{className:"text-lg font-bold text-gray-500",children:q("cart.currency")})]}),(0,i.jsxs)("div",{className:"flex items-center gap-2",children:[(0,i.jsx)("div",{className:`w-2.5 h-2.5 rounded-full ${e.inStock?"bg-green-500":"bg-red-400"}`}),(0,i.jsx)("span",{className:`text-sm font-semibold ${e.inStock?"text-green-600":"text-red-500"}`,children:e.inStock?q("product.inStock"):q("product.outOfStock")})]}),O&&V.length>0&&(0,i.jsxs)("div",{children:[(0,i.jsxs)("p",{className:"text-sm font-bold text-gray-700 mb-2",children:[K?"اختر الموديل":"Select Model",void 0!==k&&(0,i.jsxs)("span",{className:"text-purple-700 mr-2 ml-2",children:["— ",K?`موديل ${k-_+1}`:`Model ${k-_+1}`]})]}),(0,i.jsx)("div",{className:"flex flex-wrap gap-2",children:V.map((e,t)=>{let l=t+_;return(0,i.jsx)("button",{onClick:()=>{j(l),b(l)},className:`relative w-16 h-16 rounded-xl overflow-hidden border-2 transition ${k===l?"border-purple-600 ring-2 ring-purple-300":"border-gray-200 hover:border-gray-400"}`,children:(0,i.jsx)(r.default,{src:e,alt:`Model ${t+1}`,fill:!0,className:"object-cover",unoptimized:!0})},t)})}),void 0===k&&(0,i.jsx)("p",{className:"text-amber-600 text-xs mt-1.5 font-semibold",children:K?"* يرجى اختيار الموديل أولاً":"* Please select a model first"})]}),e.inStock&&(0,i.jsxs)("div",{className:"flex items-center gap-3",children:[(0,i.jsxs)("div",{className:"flex items-center border-2 border-gray-200 rounded-xl overflow-hidden",children:[(0,i.jsx)("button",{onClick:()=>f(e=>Math.max(1,e-1)),className:"w-10 h-10 flex items-center justify-center text-xl font-bold hover:bg-gray-100 transition",children:"−"}),(0,i.jsx)("span",{className:"w-10 text-center font-bold",children:w}),(0,i.jsx)("button",{onClick:()=>f(e=>e+1),className:"w-10 h-10 flex items-center justify-center text-xl font-bold hover:bg-gray-100 transition",children:"+"})]}),(0,i.jsx)("button",{onClick:function(){O&&void 0===k||(I(e,k,w),v(!0),j(void 0),f(1),setTimeout(()=>v(!1),2e3))},disabled:O&&void 0===k,className:`flex-1 font-bold py-3 px-6 rounded-xl transition text-center ${O&&void 0===k?"bg-gray-200 text-gray-400 cursor-not-allowed":"bg-purple-700 hover:bg-purple-800 text-white"}`,children:y?q("product.added"):q("product.addToCart")}),(0,i.jsx)("button",{onClick:()=>R(e),className:`w-12 h-12 shrink-0 rounded-xl border-2 flex items-center justify-center transition ${F(e.id)?"border-red-300 bg-red-50 text-red-500":"border-gray-200 hover:border-red-300 hover:bg-red-50 text-gray-400 hover:text-red-500"}`,"aria-label":F(e.id)?q("wishlist.remove"):q("wishlist.add"),children:(0,i.jsx)("svg",{className:"w-5 h-5",fill:F(e.id)?"currentColor":"none",stroke:"currentColor",strokeWidth:2,viewBox:"0 0 24 24",children:(0,i.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z"})})})]}),!e.inStock&&(0,i.jsxs)("button",{onClick:()=>R(e),className:`flex items-center gap-2 font-semibold py-2.5 px-5 rounded-xl border-2 transition text-sm ${F(e.id)?"border-red-300 bg-red-50 text-red-500":"border-gray-200 hover:border-red-300 text-gray-500 hover:text-red-500"}`,children:[(0,i.jsx)("svg",{className:"w-4 h-4",fill:F(e.id)?"currentColor":"none",stroke:"currentColor",strokeWidth:2,viewBox:"0 0 24 24",children:(0,i.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z"})}),F(e.id)?q("wishlist.added"):q("wishlist.add")]}),(0,i.jsxs)("div",{className:"flex items-center gap-2 text-sm text-gray-500",children:[(0,i.jsx)("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",strokeWidth:2,viewBox:"0 0 24 24",children:(0,i.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"})}),(0,i.jsxs)("span",{children:[K?"الوزن:":"Weight:"," ",(0,i.jsxs)("strong",{className:"text-gray-700",children:[e.weight,"g"]})]})]}),(0,i.jsx)("div",{className:"product-description border-t pt-5 mt-2",dangerouslySetInnerHTML:{__html:Y}}),e.tags.length>0&&(0,i.jsx)("div",{className:"flex flex-wrap gap-2 pt-2",children:e.tags.map(e=>(0,i.jsxs)("span",{className:"bg-gray-100 text-gray-600 text-xs px-3 py-1 rounded-full",children:["#",q(`tag.${e}`)]},e))}),(0,i.jsxs)("div",{className:"border-t pt-4 mt-1",children:[(0,i.jsx)("p",{className:"text-xs font-bold text-gray-500 uppercase tracking-widest mb-3",children:q("product.share")}),(0,i.jsxs)("div",{className:"flex items-center gap-2 flex-wrap",children:[(0,i.jsxs)("button",{onClick:()=>Z("whatsapp"),className:"flex items-center gap-1.5 bg-green-50 hover:bg-green-100 text-green-700 text-xs font-bold px-3 py-2 rounded-xl transition",children:[(0,i.jsx)("svg",{className:"w-4 h-4",fill:"currentColor",viewBox:"0 0 24 24",children:(0,i.jsx)("path",{d:"M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347zM12 0C5.373 0 0 5.373 0 12c0 2.122.549 4.116 1.512 5.852L.057 23.886a.75.75 0 00.921.921l6.163-1.543A11.94 11.94 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0z"})}),"WhatsApp"]}),(0,i.jsxs)("button",{onClick:()=>Z("facebook"),className:"flex items-center gap-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 text-xs font-bold px-3 py-2 rounded-xl transition",children:[(0,i.jsx)("svg",{className:"w-4 h-4",fill:"currentColor",viewBox:"0 0 24 24",children:(0,i.jsx)("path",{d:"M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"})}),"Facebook"]}),(0,i.jsxs)("button",{onClick:()=>Z("x"),className:"flex items-center gap-1.5 bg-gray-50 hover:bg-gray-100 text-gray-800 text-xs font-bold px-3 py-2 rounded-xl transition",children:[(0,i.jsx)("svg",{className:"w-4 h-4",fill:"currentColor",viewBox:"0 0 24 24",children:(0,i.jsx)("path",{d:"M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"})}),"X"]}),(0,i.jsxs)("button",{onClick:function(){let e=window.location.href;navigator.clipboard.writeText(e).then(()=>{N(!0),setTimeout(()=>N(!1),2e3)})},className:"flex items-center gap-1.5 bg-gray-50 hover:bg-gray-100 text-gray-600 text-xs font-bold px-3 py-2 rounded-xl transition",children:[$?(0,i.jsx)("svg",{className:"w-4 h-4 text-green-500",fill:"none",stroke:"currentColor",strokeWidth:2,viewBox:"0 0 24 24",children:(0,i.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M5 13l4 4L19 7"})}):(0,i.jsx)("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",strokeWidth:2,viewBox:"0 0 24 24",children:(0,i.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"})}),$?q("product.share.copied"):q("product.share.copy")]})]})]})]})]}),Q.length>0&&(0,i.jsxs)("div",{className:"mt-12 border-t border-gray-100 pt-10",children:[(0,i.jsxs)("h2",{className:"text-xl font-black text-gray-900 mb-6 flex items-center gap-2.5",children:[(0,i.jsx)("span",{className:"w-8 h-8 rounded-xl bg-red-600 flex items-center justify-center shrink-0",children:(0,i.jsx)("svg",{className:"w-4 h-4 text-white fill-current",viewBox:"0 0 24 24",children:(0,i.jsx)("path",{d:"M8 5v14l11-7z"})})}),K?"فيديوهات المنتج":"Product Videos"]}),(0,i.jsx)("div",{className:`grid gap-5 ${1===Q.length?"grid-cols-1 max-w-2xl":"grid-cols-1 md:grid-cols-2"}`,children:Q.map((e,t)=>(0,i.jsx)("div",{className:"rounded-2xl overflow-hidden border border-gray-100 shadow-sm bg-black aspect-video",children:(0,i.jsx)("iframe",{src:`https://www.youtube.com/embed/${e}`,title:`${U} - ${K?"فيديو":"Video"} ${t+1}`,allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0,className:"w-full h-full border-0"})},e))})]}),(g=[...e.reviews??[],...W],m="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z",(0,i.jsxs)("div",{className:"mt-12 border-t border-gray-100 pt-10",children:[(0,i.jsxs)("div",{className:"flex items-center gap-4 mb-6 flex-wrap",children:[(0,i.jsxs)("h2",{className:"text-xl font-black text-gray-900 flex items-center gap-2",children:[(0,i.jsx)("span",{children:"⭐"}),K?"آراء العملاء":"Customer Reviews"]}),g.length>0&&(u=g.reduce((e,i)=>e+i.rating,0)/g.length,(0,i.jsxs)("div",{className:"flex items-center gap-2",children:[(0,i.jsx)("div",{className:"flex gap-0.5",children:[1,2,3,4,5].map(e=>(0,i.jsx)("svg",{className:`w-5 h-5 ${e<=Math.round(u)?"text-[#F5C518]":"text-gray-200"}`,fill:"currentColor",viewBox:"0 0 20 20",children:(0,i.jsx)("path",{d:m})},e))}),(0,i.jsx)("span",{className:"font-bold text-gray-900",children:u.toFixed(1)}),(0,i.jsxs)("span",{className:"text-gray-400 text-sm",children:["(",g.length," ",K?"تقييم":"reviews",")"]})]})),(0,i.jsxs)("button",{onClick:()=>M(e=>!e),className:"mr-auto ml-auto sm:mr-0 sm:ml-0 flex items-center gap-1.5 bg-purple-50 hover:bg-purple-100 text-purple-700 text-xs font-bold px-4 py-2 rounded-xl transition",children:[(0,i.jsx)("svg",{className:"w-3.5 h-3.5",fill:"none",stroke:"currentColor",strokeWidth:2.5,viewBox:"0 0 24 24",children:(0,i.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15.232 5.232l3.536 3.536M9 11l6-6 3 3-6 6H9v-3z"})}),q("review.write")]})]}),S&&(0,i.jsx)("div",{className:"bg-gray-50 border border-gray-200 rounded-2xl p-6 mb-6",children:B?(0,i.jsx)("p",{className:"text-center text-green-700 font-bold py-4",children:q("review.success")}):(0,i.jsxs)("div",{className:"flex flex-col gap-4",children:[(0,i.jsxs)("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4",children:[(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"text-xs font-bold text-gray-700 mb-1 block",children:q("review.name")}),(0,i.jsx)("input",{type:"text",value:E,onChange:e=>A(e.target.value),placeholder:q("review.name.ph"),className:"w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-purple-400"})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"text-xs font-bold text-gray-700 mb-1 block",children:q("review.rating")}),(0,i.jsx)("div",{className:"flex gap-1 mt-1.5",children:[1,2,3,4,5].map(e=>(0,i.jsx)("button",{onClick:()=>D(e),type:"button",children:(0,i.jsx)("svg",{className:`w-7 h-7 transition ${e<=C?"text-[#F5C518]":"text-gray-300 hover:text-[#F5C518]/60"}`,fill:"currentColor",viewBox:"0 0 20 20",children:(0,i.jsx)("path",{d:m})})},e))})]})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"text-xs font-bold text-gray-700 mb-1 block",children:q("review.comment")}),(0,i.jsx)("textarea",{value:z,onChange:e=>P(e.target.value),placeholder:q("review.comment.ph"),rows:3,className:"w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-purple-400 resize-none"})]}),G&&(0,i.jsx)("p",{className:"text-red-500 text-xs font-semibold",children:q("review.required")}),(0,i.jsxs)("div",{className:"flex gap-3",children:[(0,i.jsx)("button",{onClick:function(){if(!E.trim()||!z.trim()||0===C)return void H(!0);H(!1);let i=[...W,{id:`local_${Date.now()}`,author:E.trim(),rating:C,comment:z.trim(),date:new Date().toISOString().split("T")[0],verified:!1}];T(i);try{localStorage.setItem(`reviews_${e.id}`,JSON.stringify(i))}catch{}L(!0),A(""),P(""),D(0),setTimeout(()=>{L(!1),M(!1)},3e3)},className:"bg-purple-700 hover:bg-purple-800 text-white font-bold px-6 py-2.5 rounded-xl text-sm transition",children:q("review.submit")}),(0,i.jsx)("button",{onClick:()=>{M(!1),H(!1)},className:"text-gray-500 hover:text-gray-700 text-sm font-semibold px-4 py-2.5 transition",children:K?"إلغاء":"Cancel"})]})]})}),g.length>0&&(0,i.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:g.map(e=>(0,i.jsxs)("div",{className:"bg-gray-50 rounded-2xl p-5",children:[(0,i.jsxs)("div",{className:"flex items-start justify-between gap-3 mb-3",children:[(0,i.jsxs)("div",{className:"flex items-center gap-2",children:[(0,i.jsx)("div",{className:"w-9 h-9 rounded-full bg-[#F5C518]/20 flex items-center justify-center font-black text-[#9a7b00] text-sm",children:e.author.charAt(0)}),(0,i.jsxs)("div",{children:[(0,i.jsx)("p",{className:"font-bold text-gray-900 text-sm",children:e.author}),e.verified&&(0,i.jsxs)("p",{className:"text-xs text-green-600 flex items-center gap-1",children:[(0,i.jsx)("svg",{className:"w-3 h-3",fill:"currentColor",viewBox:"0 0 20 20",children:(0,i.jsx)("path",{fillRule:"evenodd",d:"M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z",clipRule:"evenodd"})}),K?"مشترٍ موثق":"Verified purchase"]})]})]}),(0,i.jsx)("span",{className:"text-xs text-gray-400",children:new Date(e.date).toLocaleDateString(K?"ar-EG":"en-US",{year:"numeric",month:"short",day:"numeric"})})]}),(0,i.jsx)("div",{className:"flex gap-0.5 mb-2",children:[1,2,3,4,5].map(t=>(0,i.jsx)("svg",{className:`w-4 h-4 ${t<=e.rating?"text-[#F5C518]":"text-gray-200"}`,fill:"currentColor",viewBox:"0 0 20 20",children:(0,i.jsx)("path",{d:m})},t))}),(0,i.jsx)("p",{className:"text-sm text-gray-700 leading-relaxed",children:K?e.comment:e.commentEn||e.comment})]},e.id))}),0===g.length&&(0,i.jsx)("p",{className:"text-gray-400 text-sm text-center py-6",children:K?"لا توجد تقييمات بعد. كن أول من يقيّم!":"No reviews yet. Be the first to review!"})]})),X.length>0&&(0,i.jsxs)("div",{className:"mt-16",children:[(0,i.jsx)("h2",{className:"text-xl font-black text-gray-900 mb-6",children:q("product.related")}),(0,i.jsx)("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-5",children:X.map(e=>(0,i.jsx)(d.default,{product:e},e.id))})]})]})]})}e.s(["default",()=>g])}]);