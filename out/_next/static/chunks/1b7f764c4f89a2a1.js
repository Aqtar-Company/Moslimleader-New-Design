(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,65721,e=>{"use strict";let i="https://moslimleader.com/wp-content/uploads",r=[{id:"1",slug:"feast-day-game",name:"لعبة يوم الصائم",nameEn:"The Fasting Day Game",shortDescription:"لعبة لوحية جماعية يلعبها لاعبين فأكثر",shortDescriptionEn:"A group board game for 2 or more players",description:`<p>لعبة لوحية جماعية تساعد الأطفال على تعلم قيم الصيام بطريقة ممتعة وتفاعلية.</p>
<h3>المحتويات</h3>
<ul>
