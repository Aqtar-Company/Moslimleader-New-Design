(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,10607,e=>{"use strict";let i=[{id:"cairo",name:"القاهرة",nameEn:"Cairo",shipping:50},{id:"giza",name:"الجيزة",nameEn:"Giza",shipping:50},{id:"qalyubia",name:"القليوبية",nameEn:"Qalyubia",shipping:55},{id:"alexandria",name:"الإسكندرية",nameEn:"Alexandria",shipping:65},{id:"sharqia",name:"الشرقية",nameEn:"Sharqia",shipping:65},{id:"dakahlia",name:"الدقهلية",nameEn:"Dakahlia",shipping:65},{id:"gharbia",name:"الغربية",nameEn:"Gharbia",shipping:65},{id:"monufia",name:"المنوفية",nameEn:"Monufia",shipping:65},{id:"suez",name:"السويس",nameEn:"Suez",shipping:65},{id:"ismailia",name:"الإسماعيلية",nameEn:"Ismailia",shipping:65},{id:"port-said",name:"بورسعيد",nameEn:"Port Said",shipping:65},{id:"beheira",name:"البحيرة",nameEn:"Beheira",shipping:70},{id:"damietta",name:"دمياط",nameEn:"Damietta",shipping:70},{id:"kafr-sheikh",name:"كفر الشيخ",nameEn:"Kafr el-Sheikh",shipping:70},{id:"fayoum",name:"الفيوم",nameEn:"Fayoum",shipping:70},{id:"beni-suef",name:"بني سويف",nameEn:"Beni Suef",shipping:80},{id:"minya",name:"المنيا",nameEn:"Minya",shipping:80},{id:"asyut",name:"أسيوط",nameEn:"Asyut",shipping:85},{id:"sohag",name:"سوهاج",nameEn:"Sohag",shipping:85},{id:"qena",name:"قنا",nameEn:"Qena",shipping:90},{id:"luxor",name:"الأقصر",nameEn:"Luxor",shipping:90},{id:"aswan",name:"أسوان",nameEn:"Aswan",shipping:95},{id:"red-sea",name:"البحر الأحمر",nameEn:"Red Sea",shipping:95},{id:"north-sinai",name:"شمال سيناء",nameEn:"North Sinai",shipping:95},{id:"south-sinai",name:"جنوب سيناء",nameEn:"South Sinai",shipping:100},{id:"matruh",name:"مطروح",nameEn:"Matruh",shipping:100},{id:"new-valley",name:"الوادي الجديد",nameEn:"New Valley",shipping:100}];function t(e){return i.find(i=>i.id===e)?.shipping??80}e.s(["getShipping",()=>t,"governorates",0,i])},70820,e=>{"use strict";var i=e.i(4662);function t(){try{let e=localStorage.getItem("ml-coupons");if(e)return JSON.parse(e)}catch{}return{...i.DEFAULT_COUPONS}}function r(e){localStorage.setItem("ml-coupons",JSON.stringify(e))}function a(e,i){let a=t();a[e.toUpperCase().trim()]=i,r(a)}function n(e){let i=t();delete i[e],r(i)}function s(){try{let e=localStorage.getItem("ml-categories-added");if(e)return JSON.parse(e)}catch{}return[]}function l(e){localStorage.setItem("ml-categories-added",JSON.stringify(e))}function o(){try{let e=localStorage.getItem("ml_users");if(!e)return[];let i=JSON.parse(e);return Object.values(i).map(({user:e})=>{let i=d(e.id);return{id:e.id,name:e.name,email:e.email,phone:e.phone,orderCount:i.length}})}catch{return[]}}function d(e){try{let i=localStorage.getItem(`ml_orders_${e}`);if(!i)return[];let t=JSON.parse(i),r=localStorage.getItem("ml_users"),a="",n="";if(r){let i=JSON.parse(r),t=Object.values(i).find(i=>i.user.id===e);t&&(a=t.user.name,n=t.user.email)}let s=p();return t.map(i=>({...i,status:s[i.id]||i.status,userId:e,userName:a,userEmail:n}))}catch{return[]}}function c(){try{let e=localStorage.getItem("ml_users");if(!e)return[];let i=JSON.parse(e),t=[];return Object.values(i).forEach(({user:e})=>{t.push(...d(e.id))}),t.sort((e,i)=>i.id.localeCompare(e.id))}catch{return[]}}function p(){try{let e=localStorage.getItem("ml-order-status");if(e)return JSON.parse(e)}catch{}return{}}function g(e,i){let t=p();t[e]=i,localStorage.setItem("ml-order-status",JSON.stringify(t))}function m(){try{let e=localStorage.getItem("ml-product-overrides");if(e)return JSON.parse(e)}catch{}return{}}function h(e,i){let t=m();t[e]={...t[e],...i},localStorage.setItem("ml-product-overrides",JSON.stringify(t))}function u(e,i){return{...e,price:i.price??e.price,inStock:i.inStock??e.inStock,featured:i.featured??e.featured,name:i.name??e.name,nameEn:i.nameEn??e.nameEn,shortDescription:i.shortDescription??e.shortDescription,shortDescriptionEn:i.shortDescriptionEn??e.shortDescriptionEn,description:i.description??e.description,descriptionEn:i.descriptionEn??e.descriptionEn,category:i.category??e.category,variants:i.variants??e.variants,images:i.images??e.images,weight:i.weight??e.weight,tags:i.tags??e.tags}}function b(){try{let e=localStorage.getItem("ml-products-added");if(e)return JSON.parse(e)}catch{}return[]}function x(e){localStorage.setItem("ml-products-added",JSON.stringify(e))}function y(e){let i=b();i.unshift(e),x(i)}function f(e){x(b().filter(i=>i.id!==e))}function w(e,i){x(b().map(t=>t.id===e?{...t,...i}:t))}function v(e){let i=[];return e.forEach(({id:e,name:t,reviews:r})=>{r&&r.forEach(r=>i.push({id:r.id,productId:e,productName:t,author:r.author,rating:r.rating,comment:r.comment,date:r.date,isHardcoded:!0}));try{let r=localStorage.getItem(`reviews_${e}`);if(!r)return;JSON.parse(r).forEach(r=>i.push({...r,productId:e,productName:t,isHardcoded:!1}))}catch{}}),i.sort((e,i)=>i.date.localeCompare(e.date))}function k(e,i){try{let t=localStorage.getItem(`reviews_${e}`);if(!t)return;let r=JSON.parse(t).filter(e=>e.id!==i);localStorage.setItem(`reviews_${e}`,JSON.stringify(r))}catch{}}function j(){try{let e=localStorage.getItem("ml-shipping-overrides");if(e)return JSON.parse(e)}catch{}return{local:{}}}function N(e){localStorage.setItem("ml-shipping-overrides",JSON.stringify(e))}e.i(10607),e.s(["addCoupon",()=>a,"addProduct",()=>y,"applyOverride",()=>u,"deleteAddedProduct",()=>f,"deleteCoupon",()=>n,"deleteReview",()=>k,"getAddedCategories",()=>s,"getAddedProducts",()=>b,"getAllOrders",()=>c,"getAllReviews",()=>v,"getAllUsers",()=>o,"getCoupons",()=>t,"getProductOverrides",()=>m,"getShippingOverrides",()=>j,"getUserOrders",()=>d,"saveAddedCategories",()=>l,"saveAddedProducts",()=>x,"saveShippingOverrides",()=>N,"setOrderStatus",()=>g,"setProductOverride",()=>h,"updateAddedProduct",()=>w])},65721,e=>{"use strict";let i="https://moslimleader.com/wp-content/uploads",t=[{id:"1",slug:"feast-day-game",name:"لعبة يوم الصائم",nameEn:"The Fasting Day Game",shortDescription:"لعبة لوحية جماعية يلعبها لاعبين فأكثر",shortDescriptionEn:"A group board game for 2 or more players",description:`<p>لعبة لوحية جماعية تساعد الأطفال على تعلم قيم الصيام بطريقة ممتعة وتفاعلية.</p>
<h3>المحتويات</h3>
<ul>
...
</ul>`,price:35,category:"إكسسوار",tags:["دبوس","هدية","إكسسوار"],images:[`${i}/2024/10/Pins.webp`,`${i}/2024/10/Black-Pin.webp`,`${i}/2024/10/White-Pin.webp`,`${i}/2024/10/Yellow-Pin.webp`,`${i}/2024/10/Boys-Pin-1.webp`,`${i}/2024/10/Girls-Pin.webp`],inStock:!1,weight:20}],r=[{id:"all",name:"الكل",count:t.length},{id:"ألعاب تعليمية",name:"ألعاب تعليمية",count:t.filter(e=>"ألعاب تعليمية"===e.category).length},{id:"كتب",name:"كتب",count:t.filter(e=>"كتب"===e.category).length},{id:"كتب الأسرة",name:"كتب الأسرة",count:t.filter(e=>"كتب الأسرة"===e.category).length},{id:"قصص الأطفال",name:"قصص الأطفال",count:t.filter(e=>"قصص الأطفال"===e.category).length},{id:"أدوات القرآن",name:"أدوات القرآن",count:t.filter(e=>"أدوات القرآن"===e.category).length},{id:"مفكرات",name:"مفكرات",count:t.filter(e=>"مفكرات"===e.category).length},{id:"إكسسوار",name:"إكسسوار",count:t.filter(e=>"إكسسوار"===e.category).length},{id:"مجات",name:"مجات",count:t.filter(e=>"مجات"===e.category).length}];e.s(["categories",0,r,"products",0,t])},76289,e=>{"use strict";var i=e.i(43476),t=e.i(71645),r=e.i(70820),a=e.i(65721);function n(e){return new Promise((i,t)=>{let r=new FileReader;r.onload=()=>i(r.result),r.onerror=t,r.readAsDataURL(e)})}let s={slug:"",name:"",nameEn:"",shortDescription:"",shortDescriptionEn:"",description:"",descriptionEn:"",price:0,category:"",tags:[],images:[],inStock:!0,featured:!1,weight:0};function l(){let[e,l]=(0,t.useState)({}),[o,d]=(0,t.useState)([]),[c,p]=(0,t.useState)(null),[g,m]=(0,t.useState)(""),[h,u]=(0,t.useState)(!1),[b,x]=(0,t.useState)(null),[y,f]=(0,t.useState)(s),[w,v]=(0,t.useState)(""),[k,j]=(0,t.useState)([]),[N,S]=(0,t.useState)([]),[E,$]=(0,t.useState)(!1),[A,D]=(0,t.useState)(!1),P=(0,t.useRef)(null),[C,M]=(0,t.useState)([]),[z,I]=(0,t.useState)(""),G=(0,t.useCallback)(()=>{l((0,r.getProductOverrides)()),d((0,r.getAddedProducts)()),M((0,r.getAddedCategories)())},[]);(0,t.useEffect)(()=>{G()},[G]);let B=[...a.products.map(i=>({...e[i.id]?(0,r.applyOverride)(i,e[i.id]):i})),...o.map(e=>({...e,isAdded:!0}))],O=[...a.categories.filter(e=>"all"!==e.id).map(e=>e.name),...C],H=async e=>{let i=Array.from(e).filter(e=>e.type.startsWith("image/"));if(!i.length)return;let t=await Promise.all(i.map(n));j(e=>[...e,...t].slice(0,8))},L=async e=>{e.preventDefault(),$(!1),await H(e.dataTransfer.files)},F=async e=>{e.target.files&&await H(e.target.files),e.target.value=""},R=(e,i)=>{j(t=>{let r=[...t],[a]=r.splice(e,1);return r.splice(i,0,a),r})},T=e=>{let i=parseFloat(g);if(isNaN(i)||i<=0)return void p(null);if(e.isAdded){let t=o.map(t=>t.id===e.id?{...t,price:i}:t);d(t),(0,r.saveAddedProducts)(t)}else(0,r.setProductOverride)(e.id,{price:i}),G();p(null)},W=(e,i)=>S(t=>t.map(t=>t.id===e?{...t,...i}:t)),J=()=>{f(s),v(""),j([]),S([]),x(null),u(!1)},q=()=>{let e=z.trim();if(!e||C.includes(e))return;let i=[...C,e];M(i),(0,r.saveAddedCategories)(i),I("")};return(0,i.jsxs)("div",{className:"space-y-5",children:[(0,i.jsxs)("div",{className:"flex items-center justify-between",children:[(0,i.jsxs)("div",{children:[(0,i.jsx)("h1",{className:"text-xl font-black text-gray-900",children:"المنتجات"}),(0,i.jsxs)("p",{className:"text-sm text-gray-500 mt-0.5",children:[B.length," منتج"]})]}),!h&&(0,i.jsxs)("button",{onClick:()=>{x(null),u(!0)},className:"bg-[#F5C518] hover:bg-amber-400 text-[#1a1a2e] font-bold px-4 py-2.5 rounded-xl text-sm transition flex items-center gap-2",children:[(0,i.jsx)("span",{children:"+"})," إضافة منتج"]})]}),!h&&(0,i.jsxs)("div",{className:"bg-white border border-gray-200 rounded-2xl p-4 space-y-3",children:[(0,i.jsx)("h3",{className:"text-sm font-bold text-gray-700",children:"فئات مضافة"}),(0,i.jsx)("div",{className:"flex gap-2 flex-wrap",children:0===C.length?(0,i.jsx)("p",{className:"text-xs text-gray-400",children:"لا توجد فئات مضافة بعد"}):C.map(e=>(0,i.jsxs)("span",{className:"flex items-center gap-1 bg-amber-50 border border-amber-200 text-amber-800 px-3 py-1.5 rounded-full text-xs font-semibold",children:[e,(0,i.jsx)("button",{onClick:()=>{let i;M(i=C.filter(i=>i!==e)),(0,r.saveAddedCategories)(i)},className:"text-amber-400 hover:text-red-500 font-bold mr-1",children:"✕"})]},e))}),(0,i.jsxs)("div",{className:"flex gap-2",children:[(0,i.jsx)("input",{value:z,onChange:e=>I(e.target.value),onKeyDown:e=>"Enter"===e.key&&q(),placeholder:"اسم الفئة الجديدة...",className:"flex-1 border border-gray-200 rounded-xl px-3 py-2 text-sm outline-none focus:border-[#F5C518]"}),(0,i.jsx)("button",{onClick:q,className:"bg-[#1a1a2e] text-white font-bold px-4 py-2 rounded-xl text-sm hover:bg-[#2a2a4e] transition",children:"+ إضافة"})]})]}),h&&(0,i.jsxs)("div",{className:"bg-white border border-gray-200 rounded-2xl p-6 space-y-5",children:[(0,i.jsxs)("div",{className:"flex items-center justify-between",children:[(0,i.jsx)("h2",{className:"font-bold text-gray-900 text-base",children:b?"تعديل المنتج":"إضافة منتج جديد"}),(0,i.jsx)("button",{onClick:J,className:"text-gray-400 hover:text-gray-600 text-xl leading-none",children:"✕"})]}),(0,i.jsxs)("div",{children:[(0,i.jsxs)("label",{className:"block text-xs font-semibold text-gray-600 mb-2",children:["الصور * ",(0,i.jsx)("span",{className:"text-gray-400 font-normal",children:"(حتى 8 صور — الأولى هي الرئيسية)"})]}),(0,i.jsxs)("div",{onDragOver:e=>{e.preventDefault(),$(!0)},onDragLeave:()=>$(!1),onDrop:L,onClick:()=>P.current?.click(),className:`border-2 border-dashed rounded-2xl p-8 text-center cursor-pointer transition select-none ${E?"border-[#F5C518] bg-amber-50":"border-gray-200 hover:border-gray-400 hover:bg-gray-50"}`,children:[(0,i.jsx)("div",{className:"text-3xl mb-2",children:"🖼️"}),(0,i.jsx)("p",{className:"font-semibold text-gray-700 text-sm",children:"اسحب الصور هنا أو اضغط للاختيار"}),(0,i.jsx)("p",{className:"text-xs text-gray-400 mt-1",children:"PNG، JPG، WEBP — حتى 8 صور"}),(0,i.jsx)("input",{ref:P,type:"file",accept:"image/*",multiple:!0,className:"hidden",onChange:F})]}),k.length>0&&(0,i.jsxs)("div",{className:"mt-3 grid grid-cols-4 sm:grid-cols-6 lg:grid-cols-8 gap-2",children:[k.map((e,t)=>(0,i.jsxs)("div",{className:"relative group aspect-square",children:[(0,i.jsx)("img",{src:e,alt:`صورة ${t+1}`,className:"w-full h-full object-cover rounded-xl border border-gray-200"}),(0,i.jsx)("span",{className:"absolute top-1 right-1 bg-black/60 text-white text-[10px] font-bold w-5 h-5 rounded-full flex items-center justify-center",children:t+1}),(0,i.jsxs)("div",{className:"absolute inset-0 bg-black/40 rounded-xl opacity-0 group-hover:opacity-100 transition flex items-center justify-center gap-1",children:[t>0&&(0,i.jsx)("button",{onClick:e=>{e.stopPropagation(),R(t,t-1)},className:"w-6 h-6 bg-white/90 rounded-full text-xs font-bold text-gray-800 hover:bg-white",children:"›"}),(0,i.jsx)("button",{onClick:e=>{e.stopPropagation(),j(e=>e.filter((e,i)=>i!==t))},className:"w-6 h-6 bg-red-500 rounded-full text-white text-xs font-bold hover:bg-red-600",children:"✕"}),t<k.length-1&&(0,i.jsx)("button",{onClick:e=>{e.stopPropagation(),R(t,t+1)},className:"w-6 h-6 bg-white/90 rounded-full text-xs font-bold text-gray-800 hover:bg-white",children:"‹"})]}),0===t&&(0,i.jsx)("span",{className:"absolute bottom-1 left-0 right-0 text-center text-[9px] font-bold text-white bg-[#F5C518]/90 py-0.5",children:"رئيسية"})]},t)),k.length<8&&(0,i.jsx)("button",{onClick:()=>P.current?.click(),className:"aspect-square border-2 border-dashed border-gray-200 rounded-xl flex items-center justify-center text-gray-400 hover:border-gray-400 hover:text-gray-600 transition text-2xl",children:"+"})]})]}),k.length>0&&(0,i.jsxs)("div",{children:[(0,i.jsxs)("div",{className:"flex items-center justify-between mb-3",children:[(0,i.jsxs)("label",{className:"block text-xs font-semibold text-gray-600",children:["الموديلات / الألوان",(0,i.jsx)("span",{className:"text-gray-400 font-normal mr-1",children:"(اختياري)"})]}),(0,i.jsx)("button",{type:"button",onClick:()=>S(e=>[...e,{id:`v-${Date.now()}`,name:"",nameEn:"",imageIndex:-1}]),className:"text-xs font-bold bg-purple-50 hover:bg-purple-100 text-purple-700 border border-purple-200 px-3 py-1.5 rounded-lg transition",children:"+ إضافة موديل"})]}),N.length>0?(0,i.jsx)("div",{className:"space-y-3",children:N.map((e,t)=>(0,i.jsxs)("div",{className:"border border-gray-200 rounded-xl p-3 bg-gray-50 space-y-2",children:[(0,i.jsxs)("div",{className:"flex items-center gap-2",children:[(0,i.jsxs)("span",{className:"text-xs font-bold text-gray-500 w-16 shrink-0",children:["موديل ",t+1]}),(0,i.jsx)("input",{value:e.name,onChange:i=>W(e.id,{name:i.target.value}),placeholder:"الاسم (عربي)",className:"flex-1 border border-gray-200 rounded-lg px-3 py-2 text-sm outline-none focus:border-purple-400 bg-white"}),(0,i.jsx)("input",{value:e.nameEn,onChange:i=>W(e.id,{nameEn:i.target.value}),placeholder:"English name",className:"flex-1 border border-gray-200 rounded-lg px-3 py-2 text-sm outline-none focus:border-purple-400 bg-white",dir:"ltr"}),(0,i.jsx)("button",{onClick:()=>{let i;return i=e.id,S(e=>e.filter(e=>e.id!==i))},className:"text-red-400 hover:text-red-600 w-7 h-7 flex items-center justify-center rounded-lg hover:bg-red-50 transition text-sm",children:"✕"})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("p",{className:"text-xs text-gray-500 mb-1.5",children:"اختر صورة هذا الموديل:"}),(0,i.jsx)("div",{className:"flex gap-2 flex-wrap",children:k.map((t,r)=>(0,i.jsxs)("button",{type:"button",onClick:()=>W(e.id,{imageIndex:r}),className:`relative w-14 h-14 rounded-lg overflow-hidden border-2 transition ${e.imageIndex===r?"border-purple-500 ring-2 ring-purple-300":"border-gray-200 hover:border-gray-400"}`,children:[(0,i.jsx)("img",{src:t,alt:"",className:"w-full h-full object-cover"}),e.imageIndex===r&&(0,i.jsx)("div",{className:"absolute inset-0 bg-purple-500/20 flex items-center justify-center",children:(0,i.jsx)("span",{className:"text-white text-sm font-black",children:"✓"})})]},r))}),e.imageIndex<0&&(0,i.jsx)("p",{className:"text-amber-600 text-xs mt-1",children:"* اختر صورة للموديل"})]})]},e.id))}):(0,i.jsx)("p",{className:"text-xs text-gray-400 bg-gray-50 border border-dashed border-gray-200 rounded-xl px-4 py-3 text-center",children:'لو المنتج منه ألوان أو أشكال مختلفة — اضغط "إضافة موديل"'})]}),(0,i.jsxs)("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4",children:[(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"الاسم (عربي) *"}),(0,i.jsx)("input",{value:y.name,onChange:e=>f(i=>({...i,name:e.target.value})),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400"})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"الاسم (إنجليزي)"}),(0,i.jsx)("input",{value:y.nameEn||"",onChange:e=>{let i=e.target.value;f(e=>({...e,nameEn:i,slug:""===e.slug?i.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,""):e.slug}))},className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400",dir:"ltr"})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"Slug (للرابط) *"}),(0,i.jsx)("input",{value:y.slug,onChange:e=>f(i=>({...i,slug:e.target.value.toLowerCase().replace(/[^a-z0-9-]+/g,"-")})),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400 font-mono",dir:"ltr",placeholder:"product-name"})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"الفئة *"}),(0,i.jsxs)("select",{value:y.category,onChange:e=>f(i=>({...i,category:e.target.value})),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400 bg-white",children:[(0,i.jsx)("option",{value:"",children:"— اختر فئة —"}),O.map(e=>(0,i.jsx)("option",{value:e,children:e},e))]})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"السعر (EGP) *"}),(0,i.jsx)("input",{type:"number",value:y.price||"",onChange:e=>f(i=>({...i,price:+e.target.value})),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400",min:"0"})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"الوزن (جرام)"}),(0,i.jsx)("input",{type:"number",value:y.weight||"",onChange:e=>f(i=>({...i,weight:+e.target.value})),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400",min:"0"})]}),(0,i.jsxs)("div",{className:"sm:col-span-2",children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"الوصف المختصر (عربي)"}),(0,i.jsx)("input",{value:y.shortDescription,onChange:e=>f(i=>({...i,shortDescription:e.target.value})),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400"})]}),(0,i.jsxs)("div",{className:"sm:col-span-2",children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"الوصف المختصر (إنجليزي)"}),(0,i.jsx)("input",{value:y.shortDescriptionEn||"",onChange:e=>f(i=>({...i,shortDescriptionEn:e.target.value})),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400",dir:"ltr"})]}),(0,i.jsxs)("div",{className:"sm:col-span-2",children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"الوصف الكامل (عربي — HTML مسموح)"}),(0,i.jsx)("textarea",{value:y.description,onChange:e=>f(i=>({...i,description:e.target.value})),rows:4,className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400 resize-none"})]}),(0,i.jsxs)("div",{children:[(0,i.jsx)("label",{className:"block text-xs font-semibold text-gray-600 mb-1",children:"Tags (مفصولة بفاصلة)"}),(0,i.jsx)("input",{value:w,onChange:e=>v(e.target.value),className:"w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-gray-400",placeholder:"لعبة, أطفال, تعليمي"})]}),(0,i.jsxs)("div",{className:"flex items-center gap-6 pt-2",children:[(0,i.jsxs)("label",{className:"flex items-center gap-2 cursor-pointer",children:[(0,i.jsx)("input",{type:"checkbox",checked:y.inStock,onChange:e=>f(i=>({...i,inStock:e.target.checked})),className:"w-4 h-4 accent-[#F5C518]"}),(0,i.jsx)("span",{className:"text-sm font-semibold text-gray-700",children:"متوفر في المخزن"})]}),(0,i.jsxs)("label",{className:"flex items-center gap-2 cursor-pointer",children:[(0,i.jsx)("input",{type:"checkbox",checked:y.featured||!1,onChange:e=>f(i=>({...i,featured:e.target.checked})),className:"w-4 h-4 accent-[#F5C518]"}),(0,i.jsx)("span",{className:"text-sm font-semibold text-gray-700",children:"منتج مميز ⭐"})]})]})]}),(0,i.jsxs)("div",{className:"flex gap-3 pt-1 border-t border-gray-100",children:[(0,i.jsx)("button",{onClick:()=>{if(!y.name||!y.slug||!y.price||!y.category)return void alert("يرجى ملء الحقول المطلوبة: الاسم، الـ Slug، السعر، الفئة");if(0===k.length)return void alert("يرجى إضافة صورة واحدة على الأقل");D(!0);let e=N.filter(e=>e.name&&e.imageIndex>=0).map(e=>({id:e.id,name:e.name,nameEn:e.nameEn||void 0,imageIndex:e.imageIndex})),i=w.split(",").map(e=>e.trim()).filter(Boolean);if(b){let t=o.some(e=>e.id===b),a={slug:y.slug,name:y.name,nameEn:y.nameEn||void 0,shortDescription:y.shortDescription,shortDescriptionEn:y.shortDescriptionEn||void 0,description:y.description,descriptionEn:y.descriptionEn||void 0,price:y.price,category:y.category,inStock:y.inStock,featured:y.featured,weight:y.weight,tags:i,images:k,variants:e.length>0?e:void 0};t?(0,r.updateAddedProduct)(b,a):(0,r.setProductOverride)(b,a)}else(0,r.addProduct)({id:`added-${Date.now()}`,slug:y.slug,name:y.name,nameEn:y.nameEn||void 0,shortDescription:y.shortDescription,shortDescriptionEn:y.shortDescriptionEn||void 0,description:y.description,descriptionEn:y.descriptionEn||void 0,price:y.price,category:y.category,inStock:y.inStock,featured:y.featured,weight:y.weight,tags:i,images:k,variants:e.length>0?e:void 0,reviews:[]});J(),D(!1),G()},disabled:A,className:"bg-[#1a1a2e] text-white font-bold px-6 py-2.5 rounded-xl text-sm hover:bg-[#2a2a4e] transition disabled:opacity-50 flex items-center gap-2",children:A?(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("span",{className:"w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin inline-block"})," جارٍ الحفظ..."]}):b?"💾 حفظ التعديلات":"💾 حفظ المنتج"}),(0,i.jsx)("button",{onClick:J,className:"border border-gray-200 text-gray-600 font-semibold px-6 py-2.5 rounded-xl text-sm hover:bg-gray-50 transition",children:"إلغاء"})]})]}),(0,i.jsx)("div",{className:"bg-white rounded-2xl border border-gray-200 overflow-hidden",children:(0,i.jsx)("div",{className:"overflow-x-auto",children:(0,i.jsxs)("table",{className:"w-full text-sm",children:[(0,i.jsx)("thead",{className:"bg-gray-50 border-b border-gray-100",children:(0,i.jsxs)("tr",{className:"text-xs text-gray-500 font-semibold",children:[(0,i.jsx)("th",{className:"px-4 py-3.5 text-right",children:"المنتج"}),(0,i.jsx)("th",{className:"px-4 py-3.5 text-right",children:"الفئة"}),(0,i.jsx)("th",{className:"px-4 py-3.5 text-right",children:"السعر"}),(0,i.jsx)("th",{className:"px-4 py-3.5 text-center",children:"المخزون"}),(0,i.jsx)("th",{className:"px-4 py-3.5 text-center",children:"مميز"}),(0,i.jsx)("th",{className:"px-4 py-3.5 text-center",children:"إجراءات"})]})}),(0,i.jsx)("tbody",{className:"divide-y divide-gray-50",children:B.map(e=>(0,i.jsxs)("tr",{className:"hover:bg-gray-50 transition",children:[(0,i.jsx)("td",{className:"px-4 py-3",children:(0,i.jsxs)("div",{className:"flex items-center gap-3",children:[(0,i.jsx)("div",{className:"w-10 h-10 rounded-lg overflow-hidden bg-gray-100 shrink-0",children:e.images[0]&&(0,i.jsx)("img",{src:e.images[0],alt:e.name,className:"w-full h-full object-cover"})}),(0,i.jsxs)("div",{children:[(0,i.jsx)("p",{className:"font-semibold text-gray-900 text-xs leading-tight",children:e.name}),e.nameEn&&(0,i.jsx)("p",{className:"text-gray-400 text-xs",children:e.nameEn}),e.isAdded&&(0,i.jsx)("span",{className:"text-xs bg-purple-100 text-purple-600 px-1.5 py-0.5 rounded-full font-bold",children:"مضاف"})]})]})}),(0,i.jsx)("td",{className:"px-4 py-3 text-gray-500 text-xs",children:e.category}),(0,i.jsx)("td",{className:"px-4 py-3",children:c===e.id?(0,i.jsxs)("div",{className:"flex items-center gap-1.5",children:[(0,i.jsx)("input",{type:"number",value:g,onChange:e=>m(e.target.value),onKeyDown:i=>{"Enter"===i.key&&T(e),"Escape"===i.key&&p(null)},autoFocus:!0,className:"w-20 border border-gray-300 rounded-lg px-2 py-1 text-xs outline-none focus:border-[#F5C518]"}),(0,i.jsx)("button",{onClick:()=>T(e),className:"text-green-600 hover:text-green-700 font-bold text-xs",children:"✓"}),(0,i.jsx)("button",{onClick:()=>p(null),className:"text-gray-400 hover:text-gray-600 text-xs",children:"✕"})]}):(0,i.jsxs)("button",{onClick:()=>{p(e.id),m(e.price.toString())},className:"font-bold text-gray-900 hover:text-[#1a1a2e] hover:underline text-xs",children:[e.price.toLocaleString("ar-EG")," ج"]})}),(0,i.jsx)("td",{className:"px-4 py-3 text-center",children:(0,i.jsx)("button",{onClick:()=>(e=>{if(e.isAdded){let i=o.map(i=>i.id===e.id?{...i,inStock:!i.inStock}:i);d(i),(0,r.saveAddedProducts)(i)}else(0,r.setProductOverride)(e.id,{inStock:!e.inStock}),G()})(e),className:`px-2.5 py-1 rounded-full text-xs font-bold transition ${e.inStock?"bg-green-100 text-green-700 hover:bg-green-200":"bg-red-100 text-red-600 hover:bg-red-200"}`,children:e.inStock?"متوفر":"نفذ"})}),(0,i.jsx)("td",{className:"px-4 py-3 text-center",children:(0,i.jsx)("button",{onClick:()=>(e=>{if(e.isAdded){let i=o.map(i=>i.id===e.id?{...i,featured:!i.featured}:i);d(i),(0,r.saveAddedProducts)(i)}else(0,r.setProductOverride)(e.id,{featured:!e.featured}),G()})(e),className:`text-lg transition hover:scale-125 ${e.featured?"opacity-100":"opacity-25"}`,children:"⭐"})}),(0,i.jsx)("td",{className:"px-4 py-3 text-center",children:(0,i.jsxs)("div",{className:"flex items-center justify-center gap-2",children:[(0,i.jsx)("button",{onClick:()=>{x(e.id),f({slug:e.slug,name:e.name,nameEn:e.nameEn||"",shortDescription:e.shortDescription,shortDescriptionEn:e.shortDescriptionEn||"",description:e.description,descriptionEn:e.descriptionEn||"",price:e.price,category:e.category,tags:e.tags,images:e.images,inStock:e.inStock,featured:e.featured??!1,weight:e.weight}),v(e.tags.join(", ")),j([...e.images]),S(e.variants?.map(e=>({id:e.id,name:e.name,nameEn:e.nameEn||"",imageIndex:e.imageIndex}))??[]),u(!0),window.scrollTo({top:0,behavior:"smooth"})},className:"text-blue-500 hover:text-blue-700 text-xs font-bold transition hover:bg-blue-50 px-2 py-1 rounded-lg",children:"تعديل"}),e.isAdded&&(0,i.jsx)("button",{onClick:()=>{!e.isAdded||confirm(`حذف "${e.name}"؟`)&&((0,r.deleteAddedProduct)(e.id),G())},className:"text-red-400 hover:text-red-600 text-xs font-bold transition hover:bg-red-50 px-2 py-1 rounded-lg",children:"حذف"})]})})]},e.id))})]})})})]})}e.s(["default",()=>l])}]);