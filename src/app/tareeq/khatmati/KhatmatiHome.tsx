      ...
      >
        ...
        {initialGroups.length > 0 && (
          <div style={{ flexShrink: 0, marginTop: 16 }}>
            ...
            <div className="nuri-scroll" style={{ display: 'flex', gap: 10, overflowX: 'auto', paddingInline: 20, paddingBottom: 6, scrollbarWidth: 'none' }}>
              {initialGroups.map(g => {
                ...
                return (
                  <button key={g.id}
                    ...
                    style={{
                      ...
                      minWidth: 164, maxWidth: 164, flexShrink: 0, cursor: 'pointer', textAlign: 'start',
                    }}>
                    {/* Top row */}
                    <div style={{ padding: '10px 12px 8px', display: 'flex', flexDirection: 'column', gap: 4, flex: 1 }}>
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <p style={{ fontSize: 13, fontWeight: 700, color: TEXT_PRI, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: 110 }}>{g.name}</p>
        ...
        {/* No groups → spacer so lantern doesn't push content to bottom */}
        {initialGroups.length === 0 && <div style={{ flex: 1, minHeight: 20 }} />}
      </div>
