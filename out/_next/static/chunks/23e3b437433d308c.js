...
</ul>`,price:35,category:"إكسسوار",tags:["دبوس","هدية","إكسسوار"],images:[`${i}/2024/10/Pins.webp`,`${i}/2024/10/Black-Pin.webp`,`${i}/2024/10/White-Pin.webp`,`${i}/2024/10/Yellow-Pin.webp`,`${i}/2024/10/Boys-Pin-1.webp`,`${i}/2024/10/Girls-Pin.webp`],inStock:!1,weight:20}],r=[{id:"all",name:"الكل",count:t.length},{id:"ألعاب تعليمية",name:"ألعاب تعليمية",count:t.filter(e=>"ألعاب تعليمية"===e.category).length},{id:"كتب",name:"كتب",count:t.filter(e=>"كتب"===e.category).length},{id:"كتب الأسرة",name:"كتب الأسرة",count:t.filter(e=>"كتب الأسرة"===e.category).length},{id:"قصص الأطفال",name:"قصص الأطفال",count:t.filter(e=>"قصص الأطفال"===e.category).length},{id:"أدوات القرآن",name:"أدوات القرآن",count:t.filter(e=>"أدوات القرآن"===e.category).length},{id:"مفكرات",name:"مفكرات",count:t.filter(e=>"مفكرات"===e.category).length},{id:"إكسسوار",name:"إكسسوار",count:t.filter(e=>"إكسسوار"===e.category).length},{id:"مجات",name:"مجات",count:t.filter(e=>"مجات"===e.category).length}];e.s(["categories",0,r,"products",0,t],65721);var l=e.i(43476),o=e.i(22016),a=e.i(57688),s=e.i(25194),n=e.i(83773);function d({product:e}){let{addItem:i}=(0,s.useCart)(),{t,isRtl:r}=(0,n.useLang)(),d=r?e.name:e.nameEn||e.name,c=r?e.shortDescription:e.shortDescriptionEn||e.shortDescription;return(0,l.jsxs)("div",{className:"bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-gray-100 overflow-hidden flex flex-col",children:[(0,l.jsxs)(o.default,{href:`/shop/${e.slug}`,target:"_blank",rel:"noopener noreferrer",className:"block relative aspect-square overflow-hidden bg-gray-50",children:[(0,l.jsx)(a.default,{src:e.images[0],alt:d,fill:!0,className:"object-cover hover:scale-105 transition-transform duration-300",unoptimized:!0}),!e.inStock&&(0,l.jsx)("div",{className:"absolute inset-0 bg-black/40 flex items-center justify-center",children:(0,l.jsx)("span",{className:"bg-white text-gray-800 text-xs font-bold px-3 py-1 rounded-full",children:t("product.outOfStock")})})]}),(0,l.jsxs)("div",{className:"p-4 flex flex-col gap-2 flex-1",children:[(0,l.jsx)(o.default,{href:`/shop/${e.slug}`,target:"_blank",rel:"noopener noreferrer",children:(0,l.jsx)("h3",{className:"font-bold text-gray-900 text-base leading-snug hover:text-purple-700 transition line-clamp-2",children:d})}),(0,l.jsx)("p",{className:"text-gray-500 text-sm line-clamp-2",children:c}),(0,l.jsxs)("div",{className:"mt-auto pt-3 flex items-center justify-between gap-2",children:[(0,l.jsxs)("span",{className:"text-gray-900 font-bold text-lg",children:[e.price," ",t("cart.currency")]}),(0,l.jsx)("button",{disabled:!e.inStock,onClick:()=>e.inStock&&i(e),className:"bg-purple-700 hover:bg-purple-800 disabled:bg-gray-300 disabled:cursor-not-allowed text-white text-sm font-semibold px-4 py-2 rounded-xl transition",children:t(e.inStock?"product.addToCart":"product.unavailable")})]})]})]})}e.s(["default",()=>d],42129)},52683,e=>{"use strict";var i=e.i(43476),t=e.i(57688),r=e.i(71645),l=e.i(18566),o=e.i(65721),a=e.i(42129),s=e.i(83773);let n=[{src:"/family-hero.png",alt:"Moslim Leader Family"},{src:"/reading-boy-hero.png",alt:"Reading Boy"},{src:"/reading-girl-heero.jpg",alt:"Reading Girl"}];function d(){let[e,l]=(0,r.useState)(0);return(0,r.useEffect)(()=>{let e=setInterval(()=>{l(e=>(e+1)%n.length)},3e3);return()=>clearInterval(e)},[]),(0,i.jsxs)(i.Fragment,{children:[n.map((r,l)=>(0,i.jsx)(t.default,{src:r.src,alt:r.alt,fill:!0,priority:0===l,className:"object-cover object-center transition-opacity duration-1000",style:{opacity:+(l===e),zIndex:1},unoptimized:!0},r.src)),(0,i.jsx)("div",{className:"absolute bottom-16 left-1/2 -translate-x-1/2 flex gap-2",style:{zIndex:4},children:n.map((t,r)=>(0,i.jsx)("div",{className:`rounded-full transition-all duration-500 ${r===e?"w-6 h-2 bg-white":"w-2 h-2 bg-white/50"}`},r))})]})}function c({children:e}){let t=(0,r.useRef)(null);return(0,r.useEffect)(()=>{let e=t.current;if(!e)return;let i=new IntersectionObserver(([t])=>{t.isIntersecting&&(e.classList.add("is-visible"),i.disconnect())},{threshold:.08});return i.observe(e),()=>i.disconnect()},[]),(0,i.jsx)("div",{ref:t,className:"fade-section",children:e})}function p(){let e=(0,l.useSearchParams)(),{t,isRtl:n}=(0,s.useLang)(),d=e.get("category")||"all",[c,p]=(0,r.useState)(d),[h,g]=(0,r.useState)(""),u=o.products.filter(e=>{let i="all"===c||e.category===c,t=n?e.name.includes(h)||e.shortDescription.includes(h):(e.nameEn||e.name).toLowerCase().includes(h.toLowerCase())||(e.shortDescriptionEn||e.shortDescription).toLowerCase().includes(h.toLowerCase());return i&&t});return(0,i.jsxs)("div",{className:"max-w-6xl mx-auto px-4 py-10",children:[(0,i.jsx)("div",{className:"mb-8 max-w-md mx-auto",children:(0,i.jsxs)("div",{className:"relative",children:[(0,i.jsx)("input",{type:"text",placeholder:t("shop.search.ph"),value:h,onChange:e=>g(e.target.value),className:`w-full border-2 border-gray-200 focus:border-[#F5C518] rounded-xl px-4 py-3 pr-10 outline-none ${n?"text-right":"text-left"}`}),(0,i.jsxs)("svg",{className:"absolute right-3 top-3.5 w-5 h-5 text-gray-400",fill:"none",stroke:"currentColor",strokeWidth:2,viewBox:"0 0 24 24",children:[(0,i.jsx)("circle",{cx:"11",cy:"11",r:"8"}),(0,i.jsx)("path",{d:"m21 21-4.35-4.35"})]})]})}),(0,i.jsx)("div",{className:"flex flex-wrap gap-2 justify-center mb-10",children:o.categories.map(e=>(0,i.jsxs)("button",{onClick:()=>p(e.id),className:`flex items-center gap-2 px-5 py-2 rounded-full border-2 font-semibold text-sm transition ${c===e.id?"bg-gray-900 border-gray-900 text-white":"border-gray-200 hover:border-gray-900 text-gray-700"}`,children:[t(`cat.${e.id}`)||e.name,(0,i.jsx)("span",{className:`text-xs font-bold px-1.5 rounded-full ${c===e.id?"bg-white text-gray-900":"bg-gray-100"}`,children:e.count})]},e.id))}),(0,i.jsxs)("p",{className:"text-gray-500 text-sm mb-6",children:[u.length," ",t("shop.results")]}),u.length>0?(0,i.jsx)("div",{className:"grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5",children:u.map(e=>(0,i.jsx)(a.default,{product:e},e.id))}):(0,i.jsxs)("div",{className:"text-center py-20 text-gray-400",children:[(0,i.jsx)("div",{className:"text-5xl mb-4",children:"🔍"}),(0,i.jsx)("p",{className:"text-lg font-semibold",children:t("shop.empty")})]})]})}function h(){let{t:e,lang:t}=(0,s.useLang)();return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)("section",{className:"relative w-full h-screen overflow-hidden",children:[(0,i.jsx)(d,{}),(0,i.jsx)("div",{className:"absolute inset-0 bg-gradient-to-b from-transparent via-black/10 to-black/75",style:{zIndex:2}}),(0,i.jsxs)("div",{className:"absolute inset-x-0 bottom-24 flex flex-col items-center text-center px-6",style:{zIndex:3},dir:"ar"===t?"rtl":"ltr",children:[(0,i.jsx)("h1",{className:"text-4xl md:text-6xl font-black text-white drop-shadow-lg leading-tight",children:e("home.hero.title")}),(0,i.jsx)("p",{className:"text-white/80 mt-3 text-lg md:text-xl max-w-xl drop-shadow",children:e("home.hero.subtitle")})]}),(0,i.jsxs)("div",{className:"absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 animate-bounce",style:{zIndex:3},children:[(0,i.jsx)("span",{className:"text-white/60 text-xs tracking-widest uppercase",children:"scroll"}),(0,i.jsx)("svg",{className:"w-6 h-6 text-white/70",fill:"none",stroke:"currentColor",strokeWidth:2.5,viewBox:"0 0 24 24",children:(0,i.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M19 9l-7 7-7-7"})})]})]}),(0,i.jsx)(c,{children:(0,i.jsx)(r.Suspense,{children:(0,i.jsx)(p,{})})})]})}e.s(["default",()=>h])}]);