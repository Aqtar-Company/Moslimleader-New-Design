    ...
    <>
        ...
        <div className="max-w-6xl mx-auto px-4 py-10 md:py-16 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1 text-center md:text-right order-2 md:order-1">
            ...
            <p className="text-gray-700 mb-8 max-w-md mx-auto md:mx-0">
              منتجات تربوية وتعليمية للأطفال والأسرة المسلمة — ألعاب، كتب، قصص، أدوات قرآن وأكثر
            </p>
      ...
      <section className="max-w-6xl mx-auto px-4 py-14">
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          {displayCategories.map(cat => (
            ...
            >
              <span className="font-semibold text-gray-800 group-hover:text-gray-900">{cat.name}</span>
      ...
      <section className="max-w-6xl mx-auto px-4 pb-16">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl md:text-3xl font-black text-gray-900">الأكثر مبيعاً</h2>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-black text-gray-900 mb-10 text-center">لماذا مسلم ليدر؟</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                icon: '📦',
                title: 'جودة عالية',
                desc: 'كل منتج مصنوع من مواد فاخرة ومراجعته دقيقة لضمان أعلى جودة',
              },
              {
                icon: '🌟',
                title: 'محتوى هادف',
                desc: 'منتجات مستوحاة من قيم الإسلام لتربية جيل متميز ومتوازن',
              },
              {
                icon: '🚚',
                title: 'توصيل سريع',
                desc: 'نوصل لجميع محافظات مصر بسرعة وأمان',
              },
            ].map(item => (
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl md:text-3xl font-black text-gray-900">جميع المنتجات</h2>
          <Link href="/shop" className="text-purple-700 hover:text-purple-900 font-semibold text-sm transition">
            عرض الكل ←
          </Link>
        </div>
