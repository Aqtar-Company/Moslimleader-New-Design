...
const HEIR_TYPES = [
  ...
  // الحالية (اللي مفيش وحدة منها بتشير لهذه الأنواع في disallowed أصلًا).
  {
    ...
    icon: '🧒',
    color: '#5A7FA6',
    description: 'ابن الابن يقوم مقام الابن تمامًا عند غيابه: عصبة، للذكر مثل حظ الأنثيين مع البنت، ويحجب الإخوة والأعمام كما يفعل الابن. يُحجب كليًا بوجود الابن نفسه.',
    count: 0
  },
  {
    id: 'nephew',
