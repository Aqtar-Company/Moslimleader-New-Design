...
const translations = {
  ar: {
    ...
    'home.why.delivery.desc': 'نوصل لمصر والخليج والجاليات المسلمة حول العالم',
    ...
    'about.goal.text': 'تسعى مؤسسة مسلم ليدر إلى بناء الطفل المسلم ثقافيًا وفكريًا من خلال منتجات مبتكرة تتماشى مع قيمنا وأخلاقنا وهويتنا. نبتكر منتجات تبني الفكر والقيم، وتُعزّز الهوية الإسلامية، وتجمع الأسرة حول تجربة تربوية ممتعة — لنصل إلى المسلمين في العالم العربي وحول العالم.',
    ...
    'about.prod6.title': 'الملابس والشنط',
    'about.prod6.desc': 'خط ملابس وحقائب خاص بمسلم ليدر يلتزم بمعايير الاحتشام والجودة وزهاء الألوان، يحمل رسائل البراند ويجعل الطفل فخوراً بهويته في مظهره ومتعلقاته.',
    'about.tangible.title': 'لماذا المنتج الملموس؟',
    'about.tangible.text': 'الطفل يتعلم ويتشرّب القيم بحواسه: كتاب يمسكه، لعبة يلعبها مع أسرته، مفكرة يكتب فيها بيده. المنتج الملموس يبقى في بيت الأسرة سنوات ويُرى ويُهدى ويُتوارث — فيتحول كل منتج إلى سفير دائم للرسالة. كما أنه يقلل وقت الشاشات ويعيد اللعب والقراءة الحقيقية إلى يوم الطفل، وهو ما يبحث عنه الوالدان اليوم تحديدًا.',
    ...
    'product.notifyMe': 'أبلغني عند التوفر',
    'product.notifyModal.title': 'أبلغني عند توفر المنتج',
    'product.notifyModal.name': 'الاسم (اختياري)',
    'product.notifyModal.email': 'البريد الإلكتروني',
    'product.notifyModal.phone': 'رقم واتساب',
    'product.notifyModal.chooseMethod': 'اختر طريقة التواصل',
    'product.notifyModal.byEmail': 'بريد إلكتروني',
    'product.notifyModal.byWhatsapp': 'واتساب',
    'product.notifyModal.send': 'أبلغني',
    'product.notifyModal.sending': 'جارٍ الإرسال...',
    'product.notifyModal.success': 'تم! سنُبلغك عند توفر المنتج.',
    'product.notifyModal.error': 'حدث خطأ، يرجى المحاولة مرة أخرى.',
    'product.notifyModal.fillField': 'يرجى إدخال بريدك الإلكتروني أو رقم واتساب.',
    ...
    // Review form
    'review.write': 'شارك تجربتك',
    'review.name': 'الاسم',
    'review.name.ph': 'اسمك الكريم',
    'review.rating': 'التقييم',
    'review.comment': 'التجربة',
    'review.comment.ph': 'شاركنا تجربتك مع المنتج...',
    'review.submit': 'إرسال تجربتك',
    'review.success': '🎉 شكراً لمشاركة تجربتك! ستظهر قريباً.',
    ...
    // Categories
    'cat.all': 'الكل',
    'cat.الأدوات والمستلزمات الدراسية': 'الأدوات والمستلزمات الدراسية',
    'cat.القصص والكتب والروايات': 'القصص والكتب والروايات',
    'cat.الألعاب الورقية وتنمية المهارات': 'الألعاب الورقية وتنمية المهارات',
    'cat.الهدايا والمقتنيات': 'الهدايا والمقتنيات',
    'cat.أدوات تعليم القرآن': 'أدوات تعليم القرآن',
    'cat.قسم الملابس': 'قسم الملابس',
  ...
  en: {
    ...
    'home.why.delivery.desc': 'We deliver to Egypt, the Gulf, and Muslim communities worldwide',
    ...
    'about.goal.text': 'Moslim Leader Foundation aims to build the Muslim child culturally and intellectually through innovative products that align with our values, ethics, and authentic Islamic identity. We innovate products that build thought and values, strengthen Islamic identity, and bring families together in an enjoyable educational experience — reaching Muslims across the Arab world and beyond.',
    ...
    'about.prod6.title': 'Clothing & Bags',
    'about.prod6.desc': 'A Moslim Leader clothing and bags line committed to modesty, quality, and vibrant colors — carrying the brand message and letting every child wear their identity with pride in both their look and accessories.',
    'about.tangible.title': 'Why Tangible Products?',
    'about.tangible.text': 'Children absorb values through their senses: a book they hold, a game they play with family, a notebook they write in by hand. A tangible product stays in the home for years — seen, gifted, and passed on — making every product a lasting ambassador for the mission. It also reduces screen time and brings real play and reading back to the child\'s day, which is exactly what parents are looking for today.',
    ...
    'product.notifyModal.title': 'Notify Me When Available',
    'product.notifyModal.name': 'Name (optional)',
    'product.notifyModal.email': 'Email address',
    'product.notifyModal.phone': 'WhatsApp number',
    'product.notifyModal.chooseMethod': 'Choose contact method',
    'product.notifyModal.byEmail': 'Email',
    'product.notifyModal.byWhatsapp': 'WhatsApp',
    'product.notifyModal.send': 'Notify Me',
    'product.notifyModal.sending': 'Sending...',
    'product.notifyModal.success': 'Done! We will notify you when the product is available.',
    'product.notifyModal.error': 'Something went wrong, please try again.',
    'product.notifyModal.fillField': 'Please enter your email or WhatsApp number.',
    ...
    // Review form
    'review.write': 'Share Your Experience',
    'review.name': 'Name',
    'review.name.ph': 'Your name',
    'review.rating': 'Rating',
    'review.comment': 'Experience',
    'review.comment.ph': 'Share your experience with this product...',
    'review.submit': 'Share Experience',
    'review.success': '🎉 Thank you for sharing your experience! It will appear soon.',
    ...
    // Categories
    'cat.all': 'All',
    'cat.الأدوات والمستلزمات الدراسية': 'Study Tools & Supplies',
    'cat.القصص والكتب والروايات': 'Stories, Books & Novels',
    'cat.الألعاب الورقية وتنمية المهارات': 'Board Games & Skill Building',
    'cat.الهدايا والمقتنيات': 'Gifts & Collectibles',
    'cat.أدوات تعليم القرآن': 'Quran Learning Tools',
    'cat.قسم الملابس': 'Clothing',
