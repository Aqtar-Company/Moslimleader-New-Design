        ...
        <div className="flex items-start justify-between gap-3 flex-wrap">
          <div>
            ...
            <p className="text-[#F5C518]/90 text-[11px] mt-2 max-w-2xl">
              💡 الراتب الشهري: للدوام الكامل والجزئي اكتب الرقم الفعلي اللي بيتدفع شهرياً. للاستشاريين بنطبق معامل 50% (نصف الراتب فعلياً)، وللمتعاقدين 25%، عند حساب العبء السنوي.
            </p>
          </div>
