    ...
    <>
      <div className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-gray-100 overflow-hidden flex flex-col group">
        ...
        <div className="px-5 pb-4 flex items-center gap-4">
          <button
            onClick={handleLike}
            className={`flex items-center gap-1.5 text-xs font-semibold transition ${liked ? 'text-rose-500' : 'text-gray-400 hover:text-rose-400'}`}
          >
          ...
          <span className="ms-auto">
            <svg className="w-3.5 h-3.5 text-gray-200 group-hover:text-purple-300 transition" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
