(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,65721,42129,e=>{"use strict";let i="https://moslimleader.com/wp-content/uploads",r=[{id:"1",slug:"feast-day-game",name:"لعبة يوم الصائم",nameEn:"The Fasting Day Game",shortDescription:"لعبة لوحية جماعية يلعبها لاعبين فأكثر",shortDescriptionEn:"A group board game for 2 or more players",description:`<p>لعبة لوحية جماعية تساعد الأطفال على تعلم قيم الصيام بطريقة ممتعة وتفاعلية.</p>
<h3>المحتويات</h3>
<ul>
...
</ul>`,price:35,category:"إكسسوار",tags:["دبوس","هدية","إكسسوار"],images:[`${i}/2024/10/Pins.webp`,`${i}/2024/10/Black-Pin.webp`,`${i}/2024/10/White-Pin.webp`,`${i}/2024/10/Yellow-Pin.webp`,`${i}/2024/10/Boys-Pin-1.webp`,`${i}/2024/10/Girls-Pin.webp`],inStock:!1,weight:20}],t=[{id:"all",name:"الكل",count:r.length},{id:"ألعاب تعليمية",name:"ألعاب تعليمية",count:r.filter(e=>"ألعاب تعليمية"===e.category).length},{id:"كتب",name:"كتب",count:r.filter(e=>"كتب"===e.category).length},{id:"كتب الأسرة",name:"كتب الأسرة",count:r.filter(e=>"كتب الأسرة"===e.category).length},{id:"قصص الأطفال",name:"قصص الأطفال",count:r.filter(e=>"قصص الأطفال"===e.category).length},{id:"أدوات القرآن",name:"أدوات القرآن",count:r.filter(e=>"أدوات القرآن"===e.category).length},{id:"مفكرات",name:"مفكرات",count:r.filter(e=>"مفكرات"===e.category).length},{id:"إكسسوار",name:"إكسسوار",count:r.filter(e=>"إكسسوار"===e.category).length},{id:"مجات",name:"مجات",count:r.filter(e=>"مجات"===e.category).length}];e.s(["categories",0,t,"products",0,r],65721);var l=e.i(43476),a=e.i(22016),s=e.i(57688),o=e.i(25194),n=e.i(83773);function d({product:e}){let{addItem:i}=(0,o.useCart)(),{t:r,isRtl:t}=(0,n.useLang)(),d=t?e.name:e.nameEn||e.name,c=t?e.shortDescription:e.shortDescriptionEn||e.shortDescription;return(0,l.jsxs)("div",{className:"bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-gray-100 overflow-hidden flex flex-col",children:[(0,l.jsxs)(a.default,{href:`/shop/${e.slug}`,target:"_blank",rel:"noopener noreferrer",className:"block relative aspect-square overflow-hidden bg-gray-50",children:[(0,l.jsx)(s.default,{src:e.images[0],alt:d,fill:!0,className:"object-cover hover:scale-105 transition-transform duration-300",unoptimized:!0}),!e.inStock&&(0,l.jsx)("div",{className:"absolute inset-0 bg-black/40 flex items-center justify-center",children:(0,l.jsx)("span",{className:"bg-white text-gray-800 text-xs font-bold px-3 py-1 rounded-full",children:r("product.outOfStock")})})]}),(0,l.jsxs)("div",{className:"p-4 flex flex-col gap-2 flex-1",children:[(0,l.jsx)(a.default,{href:`/shop/${e.slug}`,target:"_blank",rel:"noopener noreferrer",children:(0,l.jsx)("h3",{className:"font-bold text-gray-900 text-base leading-snug hover:text-purple-700 transition line-clamp-2",children:d})}),(0,l.jsx)("p",{className:"text-gray-500 text-sm line-clamp-2",children:c}),(0,l.jsxs)("div",{className:"mt-auto pt-3 flex items-center justify-between gap-2",children:[(0,l.jsxs)("span",{className:"text-gray-900 font-bold text-lg",children:[e.price," ",r("cart.currency")]}),(0,l.jsx)("button",{disabled:!e.inStock,onClick:()=>e.inStock&&i(e),className:"bg-purple-700 hover:bg-purple-800 disabled:bg-gray-300 disabled:cursor-not-allowed text-white text-sm font-semibold px-4 py-2 rounded-xl transition",children:r(e.inStock?"product.addToCart":"product.unavailable")})]})]})]})}e.s(["default",()=>d],42129)},3365,e=>{"use strict";var i=e.i(43476),r=e.i(71645),t=e.i(57688),l=e.i(22016),a=e.i(65721),s=e.i(25194),o=e.i(83773),n=e.i(42129);function d({product:e}){let d,[c,p]=(0,r.useState)(0),[h,g]=(0,r.useState)(1),[m,u]=(0,r.useState)(!1),{addItem:b}=(0,s.useCart)(),{t:x,isRtl:w}=(0,o.useLang)(),f=e.videos??[],y=w?e.name:e.nameEn||e.name,v=w?e.shortDescription:e.shortDescriptionEn||e.shortDescription,k=w?e.description:e.descriptionEn||e.description,j=a.products.filter(i=>i.category===e.category&&i.id!==e.id).slice(0,4);return(0,i.jsxs)("div",{dir:w?"rtl":"ltr",children:[(0,i.jsx)("div",{className:"bg-gray-50 py-3 border-b",children:(0,i.jsxs)("div",{className:"max-w-6xl mx-auto px-4 flex items-center gap-2 text-sm text-gray-500",children:[(0,i.jsx)(l.default,{href:"/",className:"hover:text-gray-900 transition",children:x("nav.home")}),(0,i.jsx)("span",{children:"/"}),(0,i.jsx)(l.default,{href:"/",className:"hover:text-gray-900 transition",children:x("nav.shop")}),(0,i.jsx)("span",{children:"/"}),(0,i.jsx)("span",{className:"text-gray-900 font-medium",children:y})]})}),(0,i.jsxs)("div",{className:"max-w-6xl mx-auto px-4 py-10",children:[(0,i.jsxs)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-10",children:[(0,i.jsxs)("div",{className:"flex flex-col gap-4",children:[(0,i.jsxs)("div",{className:"relative aspect-square rounded-2xl overflow-hidden bg-gray-50 border border-gray-100",children:[(0,i.jsx)(t.default,{src:e.images[c],alt:y,fill:!0,className:"object-contain p-4",unoptimized:!0}),!e.inStock&&(0,i.jsx)("div",{className:"absolute top-3 right-3 bg-gray-900 text-white text-xs font-bold px-3 py-1 rounded-full",children:x("product.outOfStock")})]}),e.images.length>1&&(0,i.jsx)("div",{className:"flex gap-2 overflow-x-auto pb-1",children:e.images.map((e,r)=>(0,i.jsx)("button",{onClick:()=>p(r),className:`relative w-16 h-16 shrink-0 rounded-xl overflow-hidden border-2 transition ${c===r?"border-[#F5C518]":"border-gray-200 hover:border-gray-400"}`,children:(0,i.jsx)(t.default,{src:e,alt:"",fill:!0,className:"object-cover",unoptimized:!0})},r))})]}),(0,i.jsxs)("div",{className:"flex flex-col gap-5",children:[(0,i.jsx)("div",{children:(0,i.jsx)("span",{className:"bg-[#FFF9E6] text-[#9a7b00] text-xs font-bold px-3 py-1 rounded-full",children:x(`cat.${e.category}`)})}),(0,i.jsx)("h1",{className:"text-2xl md:text-3xl font-black text-gray-900 leading-tight",children:y}),(0,i.jsx)("p",{className:"text-gray-500",children:v}),(0,i.jsxs)("div",{className:"text-3xl font-black text-gray-900",children:[e.price," ",(0,i.jsx)("span",{className:"text-lg font-bold text-gray-500",children:x("cart.currency")})]}),(0,i.jsxs)("div",{className:"flex items-center gap-2",children:[(0,i.jsx)("div",{className:`w-2.5 h-2.5 rounded-full ${e.inStock?"bg-green-500":"bg-red-400"}`}),(0,i.jsx)("span",{className:`text-sm font-semibold ${e.inStock?"text-green-600":"text-red-500"}`,children:e.inStock?x("product.inStock"):x("product.outOfStock")})]}),e.inStock&&(0,i.jsxs)("div",{className:"flex items-center gap-3",children:[(0,i.jsxs)("div",{className:"flex items-center border-2 border-gray-200 rounded-xl overflow-hidden",children:[(0,i.jsx)("button",{onClick:()=>g(e=>Math.max(1,e-1)),className:"w-10 h-10 flex items-center justify-center text-xl font-bold hover:bg-gray-100 transition",children:"−"}),(0,i.jsx)("span",{className:"w-10 text-center font-bold",children:h}),(0,i.jsx)("button",{onClick:()=>g(e=>e+1),className:"w-10 h-10 flex items-center justify-center text-xl font-bold hover:bg-gray-100 transition",children:"+"})]}),(0,i.jsx)("button",{onClick:function(){for(let i=0;i<h;i++)b(e);u(!0),setTimeout(()=>u(!1),2e3)},className:"flex-1 bg-purple-700 hover:bg-purple-800 text-white font-bold py-3 px-6 rounded-xl transition text-center",children:m?x("product.added"):x("product.addToCart")})]}),(0,i.jsxs)("div",{className:"flex items-center gap-2 text-sm text-gray-500",children:[(0,i.jsx)("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",strokeWidth:2,viewBox:"0 0 24 24",children:(0,i.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"})}),(0,i.jsxs)("span",{children:[w?"الوزن:":"Weight:"," ",(0,i.jsxs)("strong",{className:"text-gray-700",children:[e.weight,"g"]})]})]}),(0,i.jsx)("div",{className:"product-description border-t pt-5 mt-2",dangerouslySetInnerHTML:{__html:k}}),e.tags.length>0&&(0,i.jsx)("div",{className:"flex flex-wrap gap-2 pt-2",children:e.tags.map(e=>(0,i.jsxs)("span",{className:"bg-gray-100 text-gray-600 text-xs px-3 py-1 rounded-full",children:["#",x(`tag.${e}`)]},e))})]})]}),f.length>0&&(0,i.jsxs)("div",{className:"mt-12 border-t border-gray-100 pt-10",children:[(0,i.jsxs)("h2",{className:"text-xl font-black text-gray-900 mb-6 flex items-center gap-2.5",children:[(0,i.jsx)("span",{className:"w-8 h-8 rounded-xl bg-red-600 flex items-center justify-center shrink-0",children:(0,i.jsx)("svg",{className:"w-4 h-4 text-white fill-current",viewBox:"0 0 24 24",children:(0,i.jsx)("path",{d:"M8 5v14l11-7z"})})}),w?"فيديوهات المنتج":"Product Videos"]}),(0,i.jsx)("div",{className:`grid gap-5 ${1===f.length?"grid-cols-1 max-w-2xl":"grid-cols-1 md:grid-cols-2"}`,children:f.map((e,r)=>(0,i.jsx)("div",{className:"rounded-2xl overflow-hidden border border-gray-100 shadow-sm bg-black aspect-video",children:(0,i.jsx)("iframe",{src:`https://www.youtube.com/embed/${e}`,title:`${y} - ${w?"فيديو":"Video"} ${r+1}`,allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0,className:"w-full h-full border-0"})},e))})]}),e.reviews&&e.reviews.length>0&&(0,i.jsxs)("div",{className:"mt-12 border-t border-gray-100 pt-10",children:[(0,i.jsxs)("div",{className:"flex items-center gap-4 mb-6 flex-wrap",children:[(0,i.jsxs)("h2",{className:"text-xl font-black text-gray-900 flex items-center gap-2",children:[(0,i.jsx)("span",{children:"⭐"}),w?"آراء العملاء":"Customer Reviews"]}),(d=e.reviews.reduce((e,i)=>e+i.rating,0)/e.reviews.length,(0,i.jsxs)("div",{className:"flex items-center gap-2",children:[(0,i.jsx)("div",{className:"flex gap-0.5",children:[1,2,3,4,5].map(e=>(0,i.jsx)("svg",{className:`w-5 h-5 ${e<=Math.round(d)?"text-[#F5C518]":"text-gray-200"}`,fill:"currentColor",viewBox:"0 0 20 20",children:(0,i.jsx)("path",{d:"M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"})},e))}),(0,i.jsx)("span",{className:"font-bold text-gray-900",children:d.toFixed(1)}),(0,i.jsxs)("span",{className:"text-gray-400 text-sm",children:["(",e.reviews.length," ",w?"تقييم":"reviews",")"]})]}))]}),(0,i.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:e.reviews.map(e=>(0,i.jsxs)("div",{className:"bg-gray-50 rounded-2xl p-5",children:[(0,i.jsxs)("div",{className:"flex items-start justify-between gap-3 mb-3",children:[(0,i.jsxs)("div",{className:"flex items-center gap-2",children:[(0,i.jsx)("div",{className:"w-9 h-9 rounded-full bg-[#F5C518]/20 flex items-center justify-center font-black text-[#9a7b00] text-sm",children:e.author.charAt(0)}),(0,i.jsxs)("div",{children:[(0,i.jsx)("p",{className:"font-bold text-gray-900 text-sm",children:e.author}),e.verified&&(0,i.jsxs)("p",{className:"text-xs text-green-600 flex items-center gap-1",children:[(0,i.jsx)("svg",{className:"w-3 h-3",fill:"currentColor",viewBox:"0 0 20 20",children:(0,i.jsx)("path",{fillRule:"evenodd",d:"M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z",clipRule:"evenodd"})}),w?"مشترٍ موثق":"Verified purchase"]})]})]}),(0,i.jsx)("span",{className:"text-xs text-gray-400",children:new Date(e.date).toLocaleDateString(w?"ar-EG":"en-US",{year:"numeric",month:"short",day:"numeric"})})]}),(0,i.jsx)("div",{className:"flex gap-0.5 mb-2",children:[1,2,3,4,5].map(r=>(0,i.jsx)("svg",{className:`w-4 h-4 ${r<=e.rating?"text-[#F5C518]":"text-gray-200"}`,fill:"currentColor",viewBox:"0 0 20 20",children:(0,i.jsx)("path",{d:"M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"})},r))}),(0,i.jsx)("p",{className:"text-sm text-gray-700 leading-relaxed",children:w?e.comment:e.commentEn||e.comment})]},e.id))})]}),j.length>0&&(0,i.jsxs)("div",{className:"mt-16",children:[(0,i.jsx)("h2",{className:"text-xl font-black text-gray-900 mb-6",children:x("product.related")}),(0,i.jsx)("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-5",children:j.map(e=>(0,i.jsx)(n.default,{product:e},e.id))})]})]})]})}e.s(["default",()=>d])}]);