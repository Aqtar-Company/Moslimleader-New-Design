    ...
    <>
      ...
      <div className="bg-gray-50 py-3 border-b">
        <div className="max-w-6xl mx-auto px-4 flex items-center gap-2 text-sm text-gray-500">
          <Link href="/" className="hover:text-gray-900 transition">الرئيسية</Link>
          <span>/</span>
          <Link href="/shop" className="hover:text-gray-900 transition">المتجر</Link>
          <span>/</span>
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="text-3xl font-black text-gray-900">
              {product.price} <span className="text-lg font-bold text-gray-500">ج.م</span>
            </div>
            ...
            <div className="product-description border-t pt-5 mt-2" dangerouslySetInnerHTML={{ __html: product.description }} />
        ...
        {related.length > 0 && (
          <div className="mt-16">
            <h2 className="text-xl font-black text-gray-900 mb-6">منتجات ذات صلة</h2>
