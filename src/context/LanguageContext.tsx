...
const translations = {
  ar: {
    ...
    'about.prod6.title': 'قسم الملابس',
    'about.prod6.desc': 'خط ملابس خاص بمسلم ليدر يلتزم بمعايير الاحتشام والجودة وزهاء الألوان، يحمل رسائل البراند ويجعل الطفل فخوراً بهويته في مظهره.',
  ...
  en: {
    ...
    'about.prod6.title': 'Clothing Line',
    'about.prod6.desc': 'A Moslim Leader clothing line committed to modesty, quality, and vibrant colors — carrying the brand message and letting every child wear their identity with pride.',
